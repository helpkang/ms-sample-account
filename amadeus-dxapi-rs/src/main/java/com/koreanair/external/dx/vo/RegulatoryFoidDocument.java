...
/**
  * Regulatory document (passport, identity card, etc.) necessary for specifying form of identification details
 **/
@ApiModel(description="Regulatory document (passport, identity card, etc.) necessary for specifying form of identification details")
public class RegulatoryFoidDocument  {
...
@XmlEnumValue("passport") PASSPORT(String.valueOf("passport")), @XmlEnumValue("identityCard") IDENTITYCARD(String.valueOf("identityCard")), @XmlEnumValue("localIdentityCard") LOCALIDENTITYCARD(String.valueOf("localIdentityCard")), @XmlEnumValue("drivingLicense") DRIVINGLICENSE(String.valueOf("drivingLicense"));
  ...
  @ApiModelProperty(required = true, value = "Type of the document : passport, identityCard...")
 /**
   * Type of the document : passport, identityCard...
  **/
  ...
  **/
  ...
  public RegulatoryFoidDocument number(String number) {
    this.number = number;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryFoidDocument effectiveDate(LocalDate effectiveDate) {
    this.effectiveDate = effectiveDate;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryFoidDocument issuanceDate(LocalDate issuanceDate) {
    this.issuanceDate = issuanceDate;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryFoidDocument expiryDate(LocalDate expiryDate) {
    this.expiryDate = expiryDate;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryFoidDocument issuanceLocation(String issuanceLocation) {
    this.issuanceLocation = issuanceLocation;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryFoidDocument issuanceCountryCode(String issuanceCountryCode) {
    this.issuanceCountryCode = issuanceCountryCode;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryFoidDocument name(Name name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryFoidDocument nationalityCode(String nationalityCode) {
    this.nationalityCode = nationalityCode;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryFoidDocument gender(GenderEnum gender) {
    this.gender = gender;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryFoidDocument birthDate(LocalDate birthDate) {
    this.birthDate = birthDate;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryFoidDocument birthPlace(String birthPlace) {
    this.birthPlace = birthPlace;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryFoidDocument remarks(List<String> remarks) {
    this.remarks = remarks;
    return this;
  }

  public RegulatoryFoidDocument addRemarksItem(String remarksItem) {
  ...
  **/
  ...
  public RegulatoryFoidDocument documentType(DocumentTypeEnum documentType) {
    this.documentType = documentType;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class RegulatoryFoidDocument {\n");
