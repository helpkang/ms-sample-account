...
public class SeatsReply  {
 ...
 /**
   * List of Seats
  **/
  private List<SeatItem> data = new ArrayList<>();
  ...
  **/
  ...
  public SeatsReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public SeatsReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public SeatsReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public SeatsReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  @JsonProperty("data")
  public List<SeatItem> getData() {
    return data;
  }

  public void setData(List<SeatItem> data) {
    this.data = data;
  }

  public SeatsReply data(List<SeatItem> data) {
    this.data = data;
    return this;
  }

  public SeatsReply addDataItem(SeatItem dataItem) {
  ...
  **/
  ...
  public SeatsReply dictionaries(DictionaryCommon dictionaries) {
    this.dictionaries = dictionaries;
    return this;
  }
