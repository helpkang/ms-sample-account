...
import com.koreanair.external.dx.vo.ContextualSeatmapReply;
import java.time.LocalDate;
import com.koreanair.external.dx.vo.Messages;
import com.koreanair.external.dx.vo.SeatmapAdvancedSearchRequest;
import com.koreanair.external.dx.vo.SeatmapReply;
...
public interface SeatmapApi  {

    /**
     * Return the seat map for a given flight. The request can be biased with some extra optional input
     *
     * Return the seat map for a given flight. The request can be baised with some extra optional input. Dictionary structure is available on page [Maps in dictionary documentation](http://e-travel.mkt.amadeus.net/dxapi/display/documentation.html#!/Maps/get). 
     *
     */
    @POST
    ...
    @ApiOperation(value = "Return the seat map for a given flight. The request can be biased with some extra optional input", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = SeatmapReply.class),
    ...
    public SeatmapReply advancedSeatmap(SeatmapAdvancedSearchRequest advancedSeatmapInputs, @QueryParam("lang")String lang, @QueryParam("currencyCode")String currencyCode);

    /**
     * Seat map from cart reference
     *
     * Return the seat map for a flight from one of the offers of the Cart identified with the flightId parameter. Not every booking class is available on every flight. Dictionary structure is available on page [Maps in dictionary documentation](http://e-travel.mkt.amadeus.net/dxapi/display/documentation.html#!/Maps/get). 
     *
     */
    @GET
    @Path("/shopping/seatmaps/by-cart")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Seat map from cart reference", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Seatmap information for a given flight based on cart content", response = ContextualSeatmapReply.class),
        @ApiResponse(code = 400, message = "Bad request", response = Messages.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Messages.class) })
    public ContextualSeatmapReply retrieveSeatMapsCartDriven(@QueryParam("cartId")String cartId, @QueryParam("flightId")String flightId, @QueryParam("airOfferId")String airOfferId, @QueryParam("travelerIds")List<String> travelerIds, @QueryParam("promotionCode")String promotionCode, @QueryParam("promotionAirlineCode")String promotionAirlineCode, @QueryParam("lang")String lang);

    /**
     * Seat map from Aircraft Configuration
     *
     * Return the aircraft seatmap representation based on the aircraft configuration version. Dictionary structure is available on page [Maps in dictionary documentation](http://e-travel.mkt.amadeus.net/dxapi/display/documentation.html#!/Maps/get). 
     *
     */
    @GET
    @Path("/shopping/seatmaps/template")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Seat map from Aircraft Configuration", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Seatmap information for flight", response = SeatmapReply.class),
        @ApiResponse(code = 400, message = "Bad request", response = Messages.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Messages.class) })
    public SeatmapReply retrieveSeatMapsFromACV(@QueryParam("marketingAirlineCode")String marketingAirlineCode, @QueryParam("aircraftConfigurationVersion")String aircraftConfigurationVersion, @QueryParam("lang")String lang);

    /**
     * Seat map from journey reference
     *
     * Return the seatmap for a specific flight (identified via the flightId parameter) part of the Journey. Seatmap will be returned for all the travelers in the provided flight and the availability of the seats will be expressed per traveler. Dictionary structure is available on page [Maps in dictionary documentation](http://e-travel.mkt.amadeus.net/dxapi/display/documentation.html#!/Maps/get). 
     *
     */
    @GET
    @Path("/shopping/seatmaps/by-journey")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Seat map from journey reference", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Seatmap information for a given flight based on journey content", response = ContextualSeatmapReply.class),
        @ApiResponse(code = 400, message = "Bad request", response = Messages.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Messages.class) })
    public ContextualSeatmapReply retrieveSeatMapsJourneyDriven(@QueryParam("journeyId")String journeyId, @QueryParam("flightId")String flightId);

    /**
     * Seat map from order reference
     *
     * Return the seat map for a flight from the Order identified with the flightId parameter. Not every cabin class is available on every flight. Dictionary structure is available on page [Maps in dictionary documentation](http://e-travel.mkt.amadeus.net/dxapi/display/documentation.html#!/Maps/get). 
     *
     */
    @GET
    @Path("/shopping/seatmaps/by-order")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Seat map from order reference", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Seatmap information for a given flight based on order content", response = ContextualSeatmapReply.class),
        @ApiResponse(code = 400, message = "Bad request", response = Messages.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Messages.class) })
    public ContextualSeatmapReply retrieveSeatMapsOrderDriven(@QueryParam("orderId")String orderId, @QueryParam("flightId")String flightId, @QueryParam("lastName")String lastName, @QueryParam("travelerIds")List<String> travelerIds, @QueryParam("promotionCode")String promotionCode, @QueryParam("promotionAirlineCode")String promotionAirlineCode, @QueryParam("lang")String lang);

    /**
     * Seat map
     *
     * Return the seat map for a given booking class. Not every booking class is available on every flight. Dictionary structure is available on page [Maps in dictionary documentation](http://e-travel.mkt.amadeus.net/dxapi/display/documentation.html#!/Maps/get). If no booking class is specified in input, the seat map for booking class &#39;Y&#39; (Economy) is returned by default. 
     *
     */
    @GET
    @Path("/shopping/seatmaps")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Seat map", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Seatmap information for flight", response = SeatmapReply.class),
        @ApiResponse(code = 400, message = "Bad request", response = Messages.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Messages.class) })
    public SeatmapReply standaloneSeatMaps(@QueryParam("marketingAirlineCode")String marketingAirlineCode, @QueryParam("marketingFlightNumber")String marketingFlightNumber, @QueryParam("originLocationCode")String originLocationCode, @QueryParam("destinationLocationCode")String destinationLocationCode, @QueryParam("departureDate")LocalDate departureDate, @QueryParam("bookingClass")String bookingClass, @QueryParam("travelerTypes")List<String> travelerTypes, @QueryParam("orderId")String orderId, @QueryParam("currencyCode")String currencyCode, @QueryParam("promotionCode")String promotionCode, @QueryParam("promotionAirlineCode")String promotionAirlineCode, @QueryParam("lang")String lang);
}
