...
/**
  * Reply containing a travel document information
 **/
@ApiModel(description="Reply containing a travel document information")
public class TravelDocumentReply  {
  ...
  **/
  ...
  private TravelDocument data = null;
  ...
  **/
  ...
  public TravelDocumentReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public TravelDocumentReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public TravelDocumentReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public TravelDocumentReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  ...
  public void setData(TravelDocument data) {
    this.data = data;
  }

  public TravelDocumentReply data(TravelDocument data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public TravelDocumentReply dictionaries(DictionaryCommon dictionaries) {
    this.dictionaries = dictionaries;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class TravelDocumentReply {\n");
