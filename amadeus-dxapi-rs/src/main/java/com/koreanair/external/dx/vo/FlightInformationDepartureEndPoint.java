...
public class FlightInformationDepartureEndPoint  {
 ...
 /**
   * Departure timings
  **/
  private FlightInformationDepartureTimings timings = null;
...
@XmlEnumValue("scheduled") SCHEDULED(String.valueOf("scheduled")), @XmlEnumValue("departed") DEPARTED(String.valueOf("departed")), @XmlEnumValue("cancelled") CANCELLED(String.valueOf("cancelled")), @XmlEnumValue("delayed") DELAYED(String.valueOf("delayed")), @XmlEnumValue("arrived") ARRIVED(String.valueOf("arrived")), @XmlEnumValue("landingCancelled") LANDINGCANCELLED(String.valueOf("landingCancelled")), @XmlEnumValue("diverted") DIVERTED(String.valueOf("diverted"));
  ...
  **/
  ...
  public FlightInformationDepartureEndPoint locationCode(String locationCode) {
    this.locationCode = locationCode;
    return this;
  }
  ...
  **/
  ...
  public FlightInformationDepartureEndPoint dateTime(LocalDateTime dateTime) {
    this.dateTime = dateTime;
    return this;
  }
  ...
  **/
  ...
  public FlightInformationDepartureEndPoint estimatedDateTime(LocalDateTime estimatedDateTime) {
    this.estimatedDateTime = estimatedDateTime;
    return this;
  }
  ...
  **/
  ...
  public FlightInformationDepartureEndPoint terminal(String terminal) {
    this.terminal = terminal;
    return this;
  }
  ...
  **/
  ...
  public FlightInformationDepartureTimings getTimings() {
    return timings;
  }

  public void setTimings(FlightInformationDepartureTimings timings) {
    this.timings = timings;
  }

  public FlightInformationDepartureEndPoint timings(FlightInformationDepartureTimings timings) {
    this.timings = timings;
    return this;
  }
  ...
  **/
  ...
  public FlightInformationDepartureEndPoint flightStatus(FlightStatusEnum flightStatus) {
    this.flightStatus = flightStatus;
    return this;
  }
  ...
  **/
  ...
  public FlightInformationDepartureEndPoint flightDelay(FlightDelay flightDelay) {
    this.flightDelay = flightDelay;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class FlightInformationDepartureEndPoint {\n");
