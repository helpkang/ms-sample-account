...
public class CarDictionary  {
  ...
  **/
  ...
  public CarDictionary location(Map<String, CarLocationDictionaryItem> location) {
    this.location = location;
    return this;
  }

  public CarDictionary putLocationItem(String key, CarLocationDictionaryItem locationItem) {
  ...
  **/
  ...
  public CarDictionary company(Map<String, CarCompanyDictionaryItem> company) {
    this.company = company;
    return this;
  }

  public CarDictionary putCompanyItem(String key, CarCompanyDictionaryItem companyItem) {
  ...
  **/
  ...
  public CarDictionary acriss(Map<String, CarAcrissCodeDictionaryItem> acriss) {
    this.acriss = acriss;
    return this;
  }

  public CarDictionary putAcrissItem(String key, CarAcrissCodeDictionaryItem acrissItem) {
  ...
  **/
  ...
  public CarDictionary shuttle(Map<String, String> shuttle) {
    this.shuttle = shuttle;
    return this;
  }

  public CarDictionary putShuttleItem(String key, String shuttleItem) {
  ...
  **/
  ...
  public CarDictionary ratingCriterion(Map<String, String> ratingCriterion) {
    this.ratingCriterion = ratingCriterion;
    return this;
  }

  public CarDictionary putRatingCriterionItem(String key, String ratingCriterionItem) {
  ...
  **/
  ...
  public CarDictionary coverage(Map<String, String> coverage) {
    this.coverage = coverage;
    return this;
  }

  public CarDictionary putCoverageItem(String key, String coverageItem) {
  ...
  **/
  ...
  public CarDictionary specialEquipment(Map<String, String> specialEquipment) {
    this.specialEquipment = specialEquipment;
    return this;
  }

  public CarDictionary putSpecialEquipmentItem(String key, String specialEquipmentItem) {
  ...
  **/
  ...
  public CarDictionary surcharge(Map<String, String> surcharge) {
    this.surcharge = surcharge;
    return this;
  }

  public CarDictionary putSurchargeItem(String key, String surchargeItem) {
  ...
  **/
  ...
  public CarDictionary tax(Map<String, String> tax) {
    this.tax = tax;
    return this;
  }

  public CarDictionary putTaxItem(String key, String taxItem) {
  ...
  **/
  ...
  public CarDictionary fuelPolicy(Map<String, String> fuelPolicy) {
    this.fuelPolicy = fuelPolicy;
    return this;
  }

  public CarDictionary putFuelPolicyItem(String key, String fuelPolicyItem) {
