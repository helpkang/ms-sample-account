...
import com.koreanair.external.dx.vo.ServicesCatalogueReply;
...
public interface ServiceApi  {
    ...
    /**
     * Retrieve catalogue of services from Cart reference
     *
     * This is a shopping transaction that returns a catalogue of services computed according to the content of a Cart. The cart id allows to access to the air offers stored in the cart such as flight characteristics, number of travelers, etc. 
     *
     */
    @GET
    @Path("/shopping/services/by-cart")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieve catalogue of services from Cart reference", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = ServicesCatalogueReply.class),
    ...
    public ServicesCatalogueReply servicesCatalogueFromCart(@QueryParam("cartId")String cartId, @QueryParam("airOfferId")String airOfferId, @QueryParam("tags")List<String> tags, @QueryParam("catalogueType")String catalogueType, @QueryParam("lang")String lang, @QueryParam("promotionCode")String promotionCode, @QueryParam("promotionAirlineCode")String promotionAirlineCode);

    /**
     * Retrieve catalogue of services from Journey reference
     *
     * This is a shopping transaction that returns a catalogue of services computed according to the content of a Journey. The journey id allows to access to the details stored in it such as flights, number of travelers, etc. 
     *
     */
    @GET
    @Path("/shopping/services/by-journey")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieve catalogue of services from Journey reference", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = ServicesCatalogueReply.class),
        @ApiResponse(code = 400, message = "Bad request", response = Messages.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Messages.class) })
    public ServicesCatalogueReply servicesCatalogueFromJourney(@QueryParam("journeyId")String journeyId, @QueryParam("tags")List<String> tags, @QueryParam("catalogueType")String catalogueType);

    /**
     * Retrieve catalogue of services from Order reference
     *
     * This is a shopping transaction that returns a catalogue of services computed according to the content of the an Order. The order id allows to access to the information of the flights (air offers) booked and stored in the order 
     *
     */
    @GET
    @Path("/shopping/services/by-order")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieve catalogue of services from Order reference", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = ServicesCatalogueReply.class),
        @ApiResponse(code = 400, message = "Bad request", response = Messages.class),
        @ApiResponse(code = 200, message = "Unexpected error", response = Messages.class) })
    public ServicesCatalogueReply servicesCatalogueFromOrder(@QueryParam("orderId")String orderId, @QueryParam("tags")List<String> tags, @QueryParam("catalogueType")String catalogueType, @QueryParam("lang")String lang, @QueryParam("promotionCode")String promotionCode, @QueryParam("promotionAirlineCode")String promotionAirlineCode);
}
