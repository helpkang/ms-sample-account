...
public class TravelerReply  {
  ...
  **/
  ...
  public TravelerReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public TravelerReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public TravelerReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public TravelerReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  ...
  public void setData(Traveler data) {
    this.data = data;
  }

  public TravelerReply data(Traveler data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public TravelerReply dictionaries(Object dictionaries) {
    this.dictionaries = dictionaries;
    return this;
  }
