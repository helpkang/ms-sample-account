...
public class RegulatoryDocumentCommon  {
...
@XmlEnumValue("male") MALE(String.valueOf("male")), @XmlEnumValue("female") FEMALE(String.valueOf("female")), @XmlEnumValue("unknown") UNKNOWN(String.valueOf("unknown"));
  ...
  **/
  ...
  public RegulatoryDocumentCommon number(String number) {
    this.number = number;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryDocumentCommon effectiveDate(LocalDate effectiveDate) {
    this.effectiveDate = effectiveDate;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryDocumentCommon issuanceDate(LocalDate issuanceDate) {
    this.issuanceDate = issuanceDate;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryDocumentCommon expiryDate(LocalDate expiryDate) {
    this.expiryDate = expiryDate;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryDocumentCommon issuanceLocation(String issuanceLocation) {
    this.issuanceLocation = issuanceLocation;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryDocumentCommon issuanceCountryCode(String issuanceCountryCode) {
    this.issuanceCountryCode = issuanceCountryCode;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryDocumentCommon name(Name name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryDocumentCommon nationalityCode(String nationalityCode) {
    this.nationalityCode = nationalityCode;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryDocumentCommon gender(GenderEnum gender) {
    this.gender = gender;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryDocumentCommon birthDate(LocalDate birthDate) {
    this.birthDate = birthDate;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryDocumentCommon birthPlace(String birthPlace) {
    this.birthPlace = birthPlace;
    return this;
  }
  ...
  **/
  ...
  public RegulatoryDocumentCommon remarks(List<String> remarks) {
    this.remarks = remarks;
    return this;
  }

  public RegulatoryDocumentCommon addRemarksItem(String remarksItem) {
  ...
  public String toString() {
    ...
    sb.append("class RegulatoryDocumentCommon {\n");
