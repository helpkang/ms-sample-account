...
/**
  * A list of hotel offers in the cart
 **/
@ApiModel(description="A list of hotel offers in the cart")
public class HotelOffersListReply  {
  ...
  **/
  ...
  private List<HotelOffer> data = null;
  ...
  **/
  ...
  public HotelOffersListReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public HotelOffersListReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public HotelOffersListReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public HotelOffersListReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  @JsonProperty("data")
  public List<HotelOffer> getData() {
    return data;
  }

  public void setData(List<HotelOffer> data) {
    this.data = data;
  }

  public HotelOffersListReply data(List<HotelOffer> data) {
    this.data = data;
    return this;
  }

  public HotelOffersListReply addDataItem(HotelOffer dataItem) {
  ...
  **/
  ...
  public HotelOffersListReply dictionaries(HotelDictionary dictionaries) {
    this.dictionaries = dictionaries;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class HotelOffersListReply {\n");
