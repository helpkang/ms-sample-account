...
import com.koreanair.external.dx.vo.InsuranceOfferReply;
import com.koreanair.external.dx.vo.InsuranceOffersReply;
...
public interface InsuranceOfferApi  {

    /**
     * Retrieve multiple insurance offers
     *
     * Returns a list of Insurance Offers. Under Implementation. 
     *
     */
    @GET
    @Path("/search/insurance-offers")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieve multiple insurance offers", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response", response = InsuranceOffersReply.class),
    ...
    public InsuranceOffersReply searchInsuranceOffersGet(@QueryParam("orderId")String orderId, @QueryParam("providerCodes")List<String> providerCodes, @QueryParam("lang")String lang);

    /**
     * Retrieve an insurance offer
     *
     * Returns the details of a specific Insurance Offer. 
     *
     */
    @GET
    @Path("/search/insurance-offers/{insuranceOfferId}")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieve an insurance offer", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response", response = InsuranceOfferReply.class),
        @ApiResponse(code = 400, message = "Bad request", response = Messages.class),
        @ApiResponse(code = 200, message = "Bad request", response = Messages.class) })
    public InsuranceOfferReply searchInsuranceOffersInsuranceOfferIdGet(@PathParam("insuranceOfferId") String insuranceOfferId);
}
