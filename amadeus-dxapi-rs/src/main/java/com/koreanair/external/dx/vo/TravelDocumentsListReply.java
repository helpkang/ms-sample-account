...
import com.koreanair.external.dx.vo.TravelDocumentsListData;
...
public class TravelDocumentsListReply  {
  ...
  **/
  ...
  private TravelDocumentsListData data = null;
  ...
  **/
  ...
  public TravelDocumentsListReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public TravelDocumentsListReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public TravelDocumentsListReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public TravelDocumentsListReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  @JsonProperty("data")
  public TravelDocumentsListData getData() {
    return data;
  }

  public void setData(TravelDocumentsListData data) {
    this.data = data;
  }

  public TravelDocumentsListReply data(TravelDocumentsListData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public TravelDocumentsListReply dictionaries(DictionaryCommon dictionaries) {
    this.dictionaries = dictionaries;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class TravelDocumentsListReply {\n");
