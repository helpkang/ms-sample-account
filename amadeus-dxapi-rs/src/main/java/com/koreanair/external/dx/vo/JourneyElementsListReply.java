...
public class JourneyElementsListReply  {
  ...
  **/
  ...
  private List<JourneyElement> data = new ArrayList<>();
  ...
  **/
  ...
  public JourneyElementsListReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public JourneyElementsListReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public JourneyElementsListReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public JourneyElementsListReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  @JsonProperty("data")
  public List<JourneyElement> getData() {
    return data;
  }

  public void setData(List<JourneyElement> data) {
    this.data = data;
  }

  public JourneyElementsListReply data(List<JourneyElement> data) {
    this.data = data;
    return this;
  }

  public JourneyElementsListReply addDataItem(JourneyElement dataItem) {
  ...
  **/
  ...
  public JourneyElementsListReply dictionaries(JourneyElementDictionary dictionaries) {
    this.dictionaries = dictionaries;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class JourneyElementsListReply {\n");
