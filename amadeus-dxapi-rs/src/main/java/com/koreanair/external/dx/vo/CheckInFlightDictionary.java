...
public class CheckInFlightDictionary  {
  ...
  **/
  ...
  public CheckInFlightDictionary flight(Map<String, CheckInFlight> flight) {
    this.flight = flight;
    return this;
  }

  public CheckInFlightDictionary putFlightItem(String key, CheckInFlight flightItem) {
  ...
  **/
  ...
  public CheckInFlightDictionary airline(Map<String, String> airline) {
    this.airline = airline;
    return this;
  }

  public CheckInFlightDictionary putAirlineItem(String key, String airlineItem) {
  ...
  **/
  ...
  public CheckInFlightDictionary aircraft(Map<String, String> aircraft) {
    this.aircraft = aircraft;
    return this;
  }

  public CheckInFlightDictionary putAircraftItem(String key, String aircraftItem) {
  ...
  **/
  ...
  public CheckInFlightDictionary location(Map<String, LocationDictionaryItem> location) {
    this.location = location;
    return this;
  }

  public CheckInFlightDictionary putLocationItem(String key, LocationDictionaryItem locationItem) {
  ...
  **/
  ...
  public CheckInFlightDictionary country(Map<String, String> country) {
    this.country = country;
    return this;
  }

  public CheckInFlightDictionary putCountryItem(String key, String countryItem) {
  ...
  public String toString() {
    ...
    sb.append("class CheckInFlightDictionary {\n");
