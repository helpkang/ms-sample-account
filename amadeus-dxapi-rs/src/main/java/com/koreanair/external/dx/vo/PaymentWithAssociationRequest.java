...
/**
  * A payment request contains: - the payment method to use for the payment - the amount and currency to be paid using that method - the items to be covered by this payment request The items to be covered by the payment request is optional. Several options are available for the API user: - The API user can provide a specific payment request for seat and services, by providing their ids. - If this is not provided, the payment request will be used to cover any items in the order Note that the payment of a specific seat and/or services should cover its full amount i.e. payment of 1 single service with multiple services is not supported. Supported payment methods are: MilesPayment, PaymentCard,  ExternalPayment or AlternativePaymentMethod. 
 **/
@ApiModel(description="A payment request contains: - the payment method to use for the payment - the amount and currency to be paid using that method - the items to be covered by this payment request The items to be covered by the payment request is optional. Several options are available for the API user: - The API user can provide a specific payment request for seat and services, by providing their ids. - If this is not provided, the payment request will be used to cover any items in the order Note that the payment of a specific seat and/or services should cover its full amount i.e. payment of 1 single service with multiple services is not supported. Supported payment methods are: MilesPayment, PaymentCard,  ExternalPayment or AlternativePaymentMethod. ")
public class PaymentWithAssociationRequest  {
  ...
  **/
  ...
  @ApiModelProperty(value = "Indicates the number of installments selected to be used for the payment. It is only available for payment with PaymentCard. ")
 /**
   * Indicates the number of installments selected to be used for the payment. It is only available for payment with PaymentCard. 
  **/
  ...
  **/
  ...
  public PaymentWithAssociationRequest paymentMethod(PaymentMethod paymentMethod) {
    this.paymentMethod = paymentMethod;
    return this;
  }
  ...
  **/
  ...
  public PaymentWithAssociationRequest amount(Amount amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public PaymentWithAssociationRequest numberOfInstallments(BigDecimal numberOfInstallments) {
    this.numberOfInstallments = numberOfInstallments;
    return this;
  }
  ...
  **/
  ...
  public PaymentWithAssociationRequest serviceItemIds(List<String> serviceItemIds) {
    this.serviceItemIds = serviceItemIds;
    return this;
  }

  public PaymentWithAssociationRequest addServiceItemIdsItem(String serviceItemIdsItem) {
  ...
  **/
  ...
  public PaymentWithAssociationRequest seatItemIds(List<String> seatItemIds) {
    this.seatItemIds = seatItemIds;
    return this;
  }

  public PaymentWithAssociationRequest addSeatItemIdsItem(String seatItemIdsItem) {
  ...
  **/
  ...
  public PaymentWithAssociationRequest currencyConversionProposalIds(List<String> currencyConversionProposalIds) {
    this.currencyConversionProposalIds = currencyConversionProposalIds;
    return this;
  }

  public PaymentWithAssociationRequest addCurrencyConversionProposalIdsItem(String currencyConversionProposalIdsItem) {
  ...
  **/
  ...
  public PaymentWithAssociationRequest authorization(PaymentAuthorizationInput authorization) {
    this.authorization = authorization;
    return this;
  }
  ...
  **/
  ...
  public PaymentWithAssociationRequest payerIdentification(PayerIdentification payerIdentification) {
    this.payerIdentification = payerIdentification;
    return this;
  }
  ...
  **/
  ...
  public PaymentWithAssociationRequest travelerIds(List<String> travelerIds) {
    this.travelerIds = travelerIds;
    return this;
  }

  public PaymentWithAssociationRequest addTravelerIdsItem(String travelerIdsItem) {
  ...
  public String toString() {
    ...
    sb.append("class PaymentWithAssociationRequest {\n");
