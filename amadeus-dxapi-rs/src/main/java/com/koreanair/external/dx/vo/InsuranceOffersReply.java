...
public class InsuranceOffersReply  {
  ...
  **/
  ...
  private List<InsuranceOffer> data = new ArrayList<>();
  ...
  **/
  ...
  public InsuranceOffersReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public InsuranceOffersReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public InsuranceOffersReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public InsuranceOffersReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  @JsonProperty("data")
  public List<InsuranceOffer> getData() {
    return data;
  }

  public void setData(List<InsuranceOffer> data) {
    this.data = data;
  }

  public InsuranceOffersReply data(List<InsuranceOffer> data) {
    this.data = data;
    return this;
  }

  public InsuranceOffersReply addDataItem(InsuranceOffer dataItem) {
  ...
  **/
  ...
  public InsuranceOffersReply dictionaries(InsuranceDictionary dictionaries) {
    this.dictionaries = dictionaries;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class InsuranceOffersReply {\n");
