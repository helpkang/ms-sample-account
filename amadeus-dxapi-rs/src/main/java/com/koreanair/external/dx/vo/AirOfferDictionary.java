...
public class AirOfferDictionary  {
  ...
  **/
  ...
  public AirOfferDictionary location(Map<String, LocationDictionaryItem> location) {
    this.location = location;
    return this;
  }

  public AirOfferDictionary putLocationItem(String key, LocationDictionaryItem locationItem) {
  ...
  **/
  ...
  public AirOfferDictionary country(Map<String, String> country) {
    this.country = country;
    return this;
  }

  public AirOfferDictionary putCountryItem(String key, String countryItem) {
  ...
  **/
  ...
  public AirOfferDictionary airline(Map<String, String> airline) {
    this.airline = airline;
    return this;
  }

  public AirOfferDictionary putAirlineItem(String key, String airlineItem) {
  ...
  **/
  ...
  public AirOfferDictionary aircraft(Map<String, String> aircraft) {
    this.aircraft = aircraft;
    return this;
  }

  public AirOfferDictionary putAircraftItem(String key, String aircraftItem) {
  ...
  **/
  ...
  public AirOfferDictionary flight(Map<String, Flight> flight) {
    this.flight = flight;
    return this;
  }

  public AirOfferDictionary putFlightItem(String key, Flight flightItem) {
  ...
  **/
  ...
  public AirOfferDictionary tax(Map<String, String> tax) {
    this.tax = tax;
    return this;
  }

  public AirOfferDictionary putTaxItem(String key, String taxItem) {
  ...
  **/
  ...
  public AirOfferDictionary surcharge(Map<String, String> surcharge) {
    this.surcharge = surcharge;
    return this;
  }

  public AirOfferDictionary putSurchargeItem(String key, String surchargeItem) {
  ...
  **/
  ...
  public AirOfferDictionary currency(Map<String, CurrencyDictionaryItem> currency) {
    this.currency = currency;
    return this;
  }

  public AirOfferDictionary putCurrencyItem(String key, CurrencyDictionaryItem currencyItem) {
  ...
  **/
  ...
  public AirOfferDictionary anonymousTraveler(Map<String, AnonymousTraveler> anonymousTraveler) {
    this.anonymousTraveler = anonymousTraveler;
    return this;
  }

  public AirOfferDictionary putAnonymousTravelerItem(String key, AnonymousTraveler anonymousTravelerItem) {
  ...
  **/
  ...
  public AirOfferDictionary discount(Map<String, DiscountDictionaryItem> discount) {
    this.discount = discount;
    return this;
  }

  public AirOfferDictionary putDiscountItem(String key, DiscountDictionaryItem discountItem) {
  ...
  **/
  ...
  public AirOfferDictionary traveler(Map<String, Traveler> traveler) {
    this.traveler = traveler;
    return this;
  }

  public AirOfferDictionary putTravelerItem(String key, Traveler travelerItem) {
  ...
  **/
  ...
  public AirOfferDictionary seatCharacteristic(Map<String, SeatCharacteristicDictionaryItem> seatCharacteristic) {
    this.seatCharacteristic = seatCharacteristic;
    return this;
  }

  public AirOfferDictionary putSeatCharacteristicItem(String key, SeatCharacteristicDictionaryItem seatCharacteristicItem) {
  ...
  **/
  ...
  public AirOfferDictionary fareFamilyWithServices(Map<String, FareFamilyWithServicesDictionaryItem> fareFamilyWithServices) {
    this.fareFamilyWithServices = fareFamilyWithServices;
    return this;
  }

  public AirOfferDictionary putFareFamilyWithServicesItem(String key, FareFamilyWithServicesDictionaryItem fareFamilyWithServicesItem) {
  ...
  public String toString() {
    ...
    sb.append("class AirOfferDictionary {\n");
