...
public class DictionaryCommon  {
  ...
  **/
  ...
  public DictionaryCommon location(Map<String, LocationDictionaryItem> location) {
    this.location = location;
    return this;
  }

  public DictionaryCommon putLocationItem(String key, LocationDictionaryItem locationItem) {
  ...
  **/
  ...
  public DictionaryCommon country(Map<String, String> country) {
    this.country = country;
    return this;
  }

  public DictionaryCommon putCountryItem(String key, String countryItem) {
  ...
  **/
  ...
  public DictionaryCommon airline(Map<String, String> airline) {
    this.airline = airline;
    return this;
  }

  public DictionaryCommon putAirlineItem(String key, String airlineItem) {
  ...
  **/
  ...
  public DictionaryCommon aircraft(Map<String, String> aircraft) {
    this.aircraft = aircraft;
    return this;
  }

  public DictionaryCommon putAircraftItem(String key, String aircraftItem) {
  ...
  **/
  ...
  public DictionaryCommon flight(Map<String, Flight> flight) {
    this.flight = flight;
    return this;
  }

  public DictionaryCommon putFlightItem(String key, Flight flightItem) {
  ...
  **/
  ...
  public DictionaryCommon tax(Map<String, String> tax) {
    this.tax = tax;
    return this;
  }

  public DictionaryCommon putTaxItem(String key, String taxItem) {
  ...
  **/
  ...
  public DictionaryCommon surcharge(Map<String, String> surcharge) {
    this.surcharge = surcharge;
    return this;
  }

  public DictionaryCommon putSurchargeItem(String key, String surchargeItem) {
  ...
  **/
  ...
  public DictionaryCommon currency(Map<String, CurrencyDictionaryItem> currency) {
    this.currency = currency;
    return this;
  }

  public DictionaryCommon putCurrencyItem(String key, CurrencyDictionaryItem currencyItem) {
  ...
  **/
  ...
  public DictionaryCommon anonymousTraveler(Map<String, AnonymousTraveler> anonymousTraveler) {
    this.anonymousTraveler = anonymousTraveler;
    return this;
  }

  public DictionaryCommon putAnonymousTravelerItem(String key, AnonymousTraveler anonymousTravelerItem) {
  ...
  **/
  ...
  public DictionaryCommon discount(Map<String, DiscountDictionaryItem> discount) {
    this.discount = discount;
    return this;
  }

  public DictionaryCommon putDiscountItem(String key, DiscountDictionaryItem discountItem) {
  ...
  **/
  ...
  public DictionaryCommon traveler(Map<String, Traveler> traveler) {
    this.traveler = traveler;
    return this;
  }

  public DictionaryCommon putTravelerItem(String key, Traveler travelerItem) {
  ...
  **/
  ...
  public DictionaryCommon seatCharacteristic(Map<String, SeatCharacteristicDictionaryItem> seatCharacteristic) {
    this.seatCharacteristic = seatCharacteristic;
    return this;
  }

  public DictionaryCommon putSeatCharacteristicItem(String key, SeatCharacteristicDictionaryItem seatCharacteristicItem) {
  ...
  public String toString() {
    ...
    sb.append("class DictionaryCommon {\n");
