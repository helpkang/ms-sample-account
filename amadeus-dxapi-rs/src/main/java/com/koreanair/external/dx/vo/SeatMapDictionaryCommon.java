...
public class SeatMapDictionaryCommon  {
  ...
  **/
  ...
  public SeatMapDictionaryCommon location(Map<String, LocationDictionaryItem> location) {
    this.location = location;
    return this;
  }

  public SeatMapDictionaryCommon putLocationItem(String key, LocationDictionaryItem locationItem) {
  ...
  **/
  ...
  public SeatMapDictionaryCommon country(Map<String, String> country) {
    this.country = country;
    return this;
  }

  public SeatMapDictionaryCommon putCountryItem(String key, String countryItem) {
  ...
  **/
  ...
  public SeatMapDictionaryCommon airline(Map<String, String> airline) {
    this.airline = airline;
    return this;
  }

  public SeatMapDictionaryCommon putAirlineItem(String key, String airlineItem) {
  ...
  **/
  ...
  public SeatMapDictionaryCommon aircraft(Map<String, String> aircraft) {
    this.aircraft = aircraft;
    return this;
  }

  public SeatMapDictionaryCommon putAircraftItem(String key, String aircraftItem) {
  ...
  public String toString() {
    ...
    sb.append("class SeatMapDictionaryCommon {\n");
