...
public class PaymentRecordDictionary  {
  ...
  **/
  ...
  public PaymentRecordDictionary currency(Map<String, CurrencyDictionaryItem> currency) {
    this.currency = currency;
    return this;
  }

  public PaymentRecordDictionary putCurrencyItem(String key, CurrencyDictionaryItem currencyItem) {
  ...
  public String toString() {
    ...
    sb.append("class PaymentRecordDictionary {\n");
