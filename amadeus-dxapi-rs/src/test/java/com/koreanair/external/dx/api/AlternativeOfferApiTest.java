 ...
 *
 * API tests for AlternativeOfferApi 
 */
public class AlternativeOfferApiTest {


    private AlternativeOfferApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://nodeA1.test.api.amadeus.com/v2", AlternativeOfferApi.class, providers);
     ...
     */
    @Test
    public void getAlternativeFlightoffersFromJourneyTest() {
        String journeyId = null;
        String searchType = null;
        //JourneyAlternativeFlightOffersReply response = api.getAlternativeFlightoffersFromJourney(journeyId, searchType);
     ...
     */
    @Test
    public void getAlternativeOffersTest() {
        String orderId = null;
        String boundId = null;
        String lastName = null;
        LocalDateTime departureDateTime = null;
        Boolean includeNearbyCities = null;
        //AlternativeOffersReply response = api.getAlternativeOffers(orderId, boundId, lastName, departureDateTime, includeNearbyCities);
        //assertNotNull(response);
        // TODO: test validations
