 ...
 *
 * API tests for TeaserApi 
 */
public class TeaserApiTest {


    private TeaserApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://nodeA1.test.api.amadeus.com/v2", TeaserApi.class, providers);
     ...
     */
    @Test
    public void retrieveTeaserDetailsTest() {
        TeaserRequest inputParams = null;
        String lang = null;
        String currencyCode = null;
        //TeasersListReply response = api.retrieveTeaserDetails(inputParams, lang, currencyCode);
     ...
     */
    @Test
    public void retrieveTeaserInfoByCartTest() {
        String cartId = null;
        List<String> recommendationTypes = null;
        //TeasersListReply response = api.retrieveTeaserInfoByCart(cartId, recommendationTypes);
        //assertNotNull(response);
        // TODO: test validations
     ...
     */
    @Test
    public void retrieveTeaserInfoByOrderTest() {
        String orderId = null;
        List<String> recommendationTypes = null;
        //TeasersListReply response = api.retrieveTeaserInfoByOrder(orderId, recommendationTypes);
        //assertNotNull(response);
        // TODO: test validations
