...
public class ServiceApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://nodeA1.test.api.amadeus.com/v2", ServiceApi.class, providers);
     ...
     */
    @Test
    public void servicesCatalogueFromCartTest() {
        String cartId = null;
        ...
        //ServicesCatalogueReply response = api.servicesCatalogueFromCart(cartId, airOfferId, tags, catalogueType, lang, promotionCode, promotionAirlineCode);
     ...
     */
    @Test
    public void servicesCatalogueFromJourneyTest() {
        String journeyId = null;
        List<String> tags = null;
        String catalogueType = null;
        //ServicesCatalogueReply response = api.servicesCatalogueFromJourney(journeyId, tags, catalogueType);
        //assertNotNull(response);
        // TODO: test validations
     ...
     */
    @Test
    public void servicesCatalogueFromOrderTest() {
        String orderId = null;
        List<String> tags = null;
        String catalogueType = null;
        String lang = null;
        String promotionCode = null;
        String promotionAirlineCode = null;
        //ServicesCatalogueReply response = api.servicesCatalogueFromOrder(orderId, tags, catalogueType, lang, promotionCode, promotionAirlineCode);
        //assertNotNull(response);
        // TODO: test validations
