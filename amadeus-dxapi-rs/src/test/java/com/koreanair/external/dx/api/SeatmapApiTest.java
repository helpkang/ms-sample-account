 ...
 *
 * API tests for SeatmapApi 
 */
public class SeatmapApiTest {


    private SeatmapApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://nodeA1.test.api.amadeus.com/v2", SeatmapApi.class, providers);
     ...
     */
    @Test
    public void advancedSeatmapTest() {
        SeatmapAdvancedSearchRequest advancedSeatmapInputs = null;
        String lang = null;
        String currencyCode = null;
        //SeatmapReply response = api.advancedSeatmap(advancedSeatmapInputs, lang, currencyCode);
     ...
     */
    @Test
    public void retrieveSeatMapsCartDrivenTest() {
        String cartId = null;
        String flightId = null;
        String airOfferId = null;
        List<String> travelerIds = null;
        String promotionCode = null;
        String promotionAirlineCode = null;
        String lang = null;
        //ContextualSeatmapReply response = api.retrieveSeatMapsCartDriven(cartId, flightId, airOfferId, travelerIds, promotionCode, promotionAirlineCode, lang);
        //assertNotNull(response);
        // TODO: test validations
     ...
     */
    @Test
    public void retrieveSeatMapsFromACVTest() {
        String marketingAirlineCode = null;
        String aircraftConfigurationVersion = null;
        String lang = null;
        //SeatmapReply response = api.retrieveSeatMapsFromACV(marketingAirlineCode, aircraftConfigurationVersion, lang);
        //assertNotNull(response);
        // TODO: test validations
     ...
     */
    @Test
    public void retrieveSeatMapsJourneyDrivenTest() {
        String journeyId = null;
        String flightId = null;
        //ContextualSeatmapReply response = api.retrieveSeatMapsJourneyDriven(journeyId, flightId);
        //assertNotNull(response);
        // TODO: test validations
     ...
     */
    @Test
    public void retrieveSeatMapsOrderDrivenTest() {
        String orderId = null;
        String flightId = null;
        ...
        String promotionAirlineCode = null;
        String lang = null;
        //ContextualSeatmapReply response = api.retrieveSeatMapsOrderDriven(orderId, flightId, lastName, travelerIds, promotionCode, promotionAirlineCode, lang);
        //assertNotNull(response);
        // TODO: test validations
     ...
     */
    @Test
    public void standaloneSeatMapsTest() {
        String marketingAirlineCode = null;
        String marketingFlightNumber = null;
        String originLocationCode = null;
        String destinationLocationCode = null;
        LocalDate departureDate = null;
        String bookingClass = null;
        List<String> travelerTypes = null;
        String orderId = null;
        String currencyCode = null;
        String promotionCode = null;
        String promotionAirlineCode = null;
        String lang = null;
        //SeatmapReply response = api.standaloneSeatMaps(marketingAirlineCode, marketingFlightNumber, originLocationCode, destinationLocationCode, departureDate, bookingClass, travelerTypes, orderId, currencyCode, promotionCode, promotionAirlineCode, lang);
        //assertNotNull(response);
        // TODO: test validations
