...
public class UpgradesApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://nodeA1.test.api.amadeus.com/v2", UpgradesApi.class, providers);
     ...
     */
    @Test
    public void priceUpgradesFromJourneyTest() {
        String journeyId = null;
        JourneyUpgradePriceRequest upgradeJourneyPriceInput = null;
        //JourneyUpgradePriceReply response = api.priceUpgradesFromJourney(journeyId, upgradeJourneyPriceInput);
     ...
     */
    @Test
    public void shopUpgradesFromJourneyTest() {
        String journeyId = null;
        //JourneyUpgradeShopReply response = api.shopUpgradesFromJourney(journeyId);
        //assertNotNull(response);
        // TODO: test validations
