 ...
 *
 * API tests for InsuranceOfferApi 
 */
public class InsuranceOfferApiTest {


    private InsuranceOfferApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://nodeA1.test.api.amadeus.com/v2", InsuranceOfferApi.class, providers);
     ...
     */
    @Test
    public void searchInsuranceOffersGetTest() {
        String orderId = null;
        List<String> providerCodes = null;
        String lang = null;
        //InsuranceOffersReply response = api.searchInsuranceOffersGet(orderId, providerCodes, lang);
     ...
     */
    @Test
    public void searchInsuranceOffersInsuranceOfferIdGetTest() {
        String insuranceOfferId = null;
        //InsuranceOfferReply response = api.searchInsuranceOffersInsuranceOfferIdGet(insuranceOfferId);
        //assertNotNull(response);
        // TODO: test validations
