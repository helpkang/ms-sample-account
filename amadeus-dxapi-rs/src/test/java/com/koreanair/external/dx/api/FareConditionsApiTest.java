 ...
 *
 * API tests for FareConditionsApi 
 */
public class FareConditionsApiTest {


    private FareConditionsApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://nodeA1.test.api.amadeus.com/v2", FareConditionsApi.class, providers);
     ...
     */
    @Test
    public void airOfferConditionsTest() {
        String cartId = null;
        String airOfferId = null;
        String orderId = null;
        String lang = null;
        //AirOfferConditionsReply response = api.airOfferConditions(cartId, airOfferId, orderId, lang);
     ...
     */
    @Test
    public void getBaggagePoliciesTest() {
        String cartId = null;
        String orderId = null;
        String lang = null;
        //BaggagePoliciesReply response = api.getBaggagePolicies(cartId, orderId, lang);
        //assertNotNull(response);
        // TODO: test validations
     ...
     */
    @Test
    public void getBaggagePoliciesFromJourneyTest() {
        String journeyId = null;
        //CheckInBaggagePoliciesReply response = api.getBaggagePoliciesFromJourney(journeyId);
        //assertNotNull(response);
        // TODO: test validations
