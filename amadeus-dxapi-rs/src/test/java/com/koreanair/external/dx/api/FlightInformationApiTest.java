 ...
 *
 * API tests for FlightInformationApi 
 */
public class FlightInformationApiTest {


    private FlightInformationApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://nodeA1.test.api.amadeus.com/v2", FlightInformationApi.class, providers);
     ...
     */
    @Test
    public void standaloneFlightInfoTest() {
        String marketingAirlineCode = null;
        String marketingFlightNumber = null;
        LocalDate departureDate = null;
        //FlightInformationReply response = api.standaloneFlightInfo(marketingAirlineCode, marketingFlightNumber, departureDate);
     ...
     */
    @Test
    public void standaloneFlightTimetableTest() {
        String originLocationCode = null;
        String destinationLocationCode = null;
        LocalDate departureDate = null;
        //FlightTimetableListReply response = api.standaloneFlightTimetable(originLocationCode, destinationLocationCode, departureDate);
        //assertNotNull(response);
        // TODO: test validations
