...
public class PaymentApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://nodeA1.test.api.amadeus.com/v2", PaymentApi.class, providers);
     ...
     */
    @Test
    public void getPaymentCurrencyConversionProposalsTest() {
        PaymentCurrencyConversionProposalListRequest getcurrencyConversionProposalsBody = null;
        String lang = null;
        //PaymentCurrencyConversionProposalListReply response = api.getPaymentCurrencyConversionProposals(getcurrencyConversionProposalsBody, lang);
     ...
     */
    @Test
    public void getPaymentMethodMilesCashTest() {
        String cartId = null;
        String orderId = null;
        String frequentFlyerCardId = null;
        String lang = null;
        //MilesCashSplitListReply response = api.getPaymentMethodMilesCash(cartId, orderId, frequentFlyerCardId, lang);
        //assertNotNull(response);
        // TODO: test validations
     ...
     */
    @Test
    public void searchAndValidatePaymentMethodsTest() {
        ValidatePaymentMethodsRequest createPaymentRecordsBody = null;
        String lang = null;
        //ValidatePaymentMethodsReply response = api.searchAndValidatePaymentMethods(createPaymentRecordsBody, lang);
        //assertNotNull(response);
        // TODO: test validations
