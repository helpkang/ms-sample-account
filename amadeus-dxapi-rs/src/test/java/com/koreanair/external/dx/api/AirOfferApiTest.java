 ...
 *
 * API tests for AirOfferApi
 */
public class AirOfferApiTest {


    private AirOfferApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://nodeA1.test.api.amadeus.com/v2", AirOfferApi.class, providers);
     ...
     */
    @Test
    public void advancedAirShoppingTest() {
        AirOffersAdvancedSearchRequest advancedInputs = null;
        String lang = null;
        //AirOffersListReply response = api.advancedAirShopping(advancedInputs, lang);
    ...
    public void airShoppingTest() {
        ...
        String lang = null;
        //AirOffersListReply response = api.airShopping(departureDateTime, originLocationCode, destinationLocationCode, commercialFareFamilies, returnDateTime, travelers, max, maxPrice, departureTimeWindow, returnTimeWindow, alternateOriginLocationCode, alternateDestinationLocationCode, corporateCodes, directFlights, promotionCode, promotionAirlineCode, showSoldOut, lang);
        //assertNotNull(response);
        // TODO: test validations
     ...
     */
    @Test
    public void retrieveAirOfferTest() {
        String airOfferId = null;
        String lang = null;
        AirOfferReply response = api.retrieveAirOffer(airOfferId, lang);
        assertNotNull(response);
        // TODO: test validations
