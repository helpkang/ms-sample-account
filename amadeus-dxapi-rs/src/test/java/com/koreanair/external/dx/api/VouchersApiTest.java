...
public class VouchersApiTest {
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://nodeA1.test.api.amadeus.com/v2", VouchersApi.class, providers);
    ...
    public void createVoucherTest() {
        VoucherPostRequest postVoucherBody = null;
        //RetrieveVoucherReply response = api.createVoucher(postVoucherBody);
     ...
     */
    @Test
    public void retrieveVoucherTest() {
        String voucherId = null;
        VoucherRetrieveRequest voucherRetrieveRequest = null;
        //RetrieveVoucherReply response = api.retrieveVoucher(voucherId, voucherRetrieveRequest);
        //assertNotNull(response);
        // TODO: test validations
     ...
     */
    @Test
    public void topUpVoucherTest() {
        String voucherId = null;
        VoucherTopUpRequest postVoucherTopUpBody = null;
        //RetrieveVoucherReply response = api.topUpVoucher(voucherId, postVoucherTopUpBody);
        //assertNotNull(response);
        // TODO: test validations
