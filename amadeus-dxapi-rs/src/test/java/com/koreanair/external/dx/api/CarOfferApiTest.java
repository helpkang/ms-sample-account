...
import com.koreanair.external.dx.vo.CarOfferReply;
import com.koreanair.external.dx.vo.CarOffersListReply;
 ...
 *
 * API tests for CarOfferApi 
 */
public class CarOfferApiTest {


    private CarOfferApi api;
    ...
    public void setup() {
        ...
        api = JAXRSClientFactory.create("https://nodeA1.test.api.amadeus.com/v2", CarOfferApi.class, providers);
    ...
    /**
     * Retrieve catalog of Car rentals
     *
     * This is a shopping transaction that returns a list of car offers. The minimum input parameters to use are pickUpDateTime, dropOffDateTime and the pickup location (e.g. pickUpLocationCode or providerPickUpLocationCode) 
     *
     * @throws ApiException
    ...
    public void carAvailabilityTest() {
        ...
        LocalDateTime dropOffDateTime = null;
        List<String> providerCodes = null;
        String pickUpLocationCode = null;
        String dropOffLocationCode = null;
        List<String> providerPickUpLocationCodes = null;
        List<String> providerDropOffLocationCodes = null;
        List<String> acrissCodes = null;
        Boolean acrissCodesExclusion = null;
        List<String> vehicleImageSizes = null;
        List<String> providerLogoSizes = null;
        Integer driverAge = null;
        String rateClass = null;
        String currencyCode = null;
        List<String> carLoyaltyNumbers = null;
        Boolean isUnlimitedMileage = null;
        ...
        Double pickUpRadius = null;
        Double dropOffRadius = null;
        String radiusUnit = null;
        List<String> bookingAgencies = null;
        String lang = null;
        //CarOffersListReply response = api.carAvailability(pickUpDateTime, dropOffDateTime, providerCodes, pickUpLocationCode, dropOffLocationCode, providerPickUpLocationCodes, providerDropOffLocationCodes, acrissCodes, acrissCodesExclusion, vehicleImageSizes, providerLogoSizes, driverAge, rateClass, currencyCode, carLoyaltyNumbers, isUnlimitedMileage, minPrice, maxPrice, pickUpLatitude, pickUpLongitude, dropOffLatitude, dropOffLongitude, pickUpRadius, dropOffRadius, radiusUnit, bookingAgencies, lang);
    ...
    /**
     * Retrieve the details of the car associated to the referenced car offer
     *
     * This is a shopping transaction that returns the details of the car associated to the referenced car offer. The &#39;carOfferId&#39; parameter should refer to one of the car offers returned by the GET /search/car-offers operation. 
     *
     * @throws ApiException
     *          if the Api call fails
     */
    @Test
    public void carTermsFromAvailabilityTest() {
        String carOfferId = null;
        String lang = null;
        //CarOfferReply response = api.carTermsFromAvailability(carOfferId, lang);
        //assertNotNull(response);
        // TODO: test validations
