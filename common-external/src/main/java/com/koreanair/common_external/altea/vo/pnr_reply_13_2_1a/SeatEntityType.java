...
public class SeatEntityType {
    ...
    protected List<IndividualSeatGroup> individualSeatGroup;
     ...
     * {@link IndividualSeatGroup }
     * 
     * 
     */
    public List<IndividualSeatGroup> getIndividualSeatGroup() {
        if (individualSeatGroup == null) {
            individualSeatGroup = new ArrayList<IndividualSeatGroup>();
        }
