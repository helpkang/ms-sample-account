...
public class TicketCancelDocumentReply {
    ...
    protected List<TransactionResults> transactionResults;
     ...
     * 
     */
    public List<TransactionResults> getTransactionResults() {
        if (transactionResults == null) {
            transactionResults = new ArrayList<TransactionResults>();
        }
