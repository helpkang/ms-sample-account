...
public class PQRdataType {
     ...
     *     
     */
    public void setDocumentDetailsGroup(DocumentDetailsGroup value) {
    ...
    public static class DocumentDetailsGroup {
        ...
        @XmlElement(required = true)
        protected List<CouponDetailsGroup> couponDetailsGroup;
