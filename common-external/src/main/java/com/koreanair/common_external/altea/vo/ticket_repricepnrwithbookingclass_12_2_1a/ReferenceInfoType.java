 ...
 *       &lt;sequence>
 *         &lt;element name="referenceDetails" type="{http://xml.amadeus.com/TARIPQ_12_2_1A}ReferencingDetailsType_221370C" maxOccurs="999" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ReferenceInfoType {
    ...
    protected List<ReferencingDetailsType221370C> referenceDetails;
     ...
     * {@link ReferencingDetailsType221370C }
     * 
     * 
     */
    public List<ReferencingDetailsType221370C> getReferenceDetails() {
        if (referenceDetails == null) {
            referenceDetails = new ArrayList<ReferencingDetailsType221370C>();
        }
