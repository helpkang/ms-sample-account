...
public class TourAccountDetailsType {
    ...
    protected List<RemainingAmountsDetails> remainingAmountsDetails;
    protected List<TourDetailedPriceInfo> tourDetailedPriceInfo;
