 ...
 *       &lt;sequence>
 *         &lt;element name="merchantInformation" type="{http://xml.amadeus.com/TFOPCQ_11_1_1A}CompanyInformationType_68665S"/>
 *         &lt;element name="monetaryInformation" type="{http://xml.amadeus.com/TFOPCQ_11_1_1A}MonetaryInformationType" maxOccurs="999" minOccurs="0"/>
 *         &lt;element name="paymentId" type="{http://xml.amadeus.com/TFOPCQ_11_1_1A}ItemReferencesAndVersionsType" maxOccurs="3" minOccurs="0"/>
 *         &lt;element name="extendedPaymentInfo" type="{http://xml.amadeus.com/TFOPCQ_11_1_1A}FrequencyTypeU" minOccurs="0"/>
 *         &lt;element name="transactionDateTime" type="{http://xml.amadeus.com/TFOPCQ_11_1_1A}StructuredDateTimeInformationType" minOccurs="0"/>
 *         &lt;element name="expirationPeriod" type="{http://xml.amadeus.com/TFOPCQ_11_1_1A}QuantityType" minOccurs="0"/>
 *         &lt;element name="distributionChannelInformation" type="{http://xml.amadeus.com/TFOPCQ_11_1_1A}TerminalIdentificationDescriptionType" minOccurs="0"/>
 *         &lt;element name="purchaseDescription" type="{http://xml.amadeus.com/TFOPCQ_11_1_1A}FreeTextInformationType_68651S" minOccurs="0"/>
 *         &lt;element name="fraudScreeningData" type="{http://xml.amadeus.com/TFOPCQ_11_1_1A}FraudScreeningGroupType" minOccurs="0"/>
 *         &lt;element name="paymentDataMap" type="{http://xml.amadeus.com/TFOPCQ_11_1_1A}AttributeType_68664S" maxOccurs="99" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PaymentDataGroupType {
    ...
    protected List<AttributeType68664S> paymentDataMap;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AttributeType68664S }
     * 
     * 
     */
    public List<AttributeType68664S> getPaymentDataMap() {
        if (paymentDataMap == null) {
            paymentDataMap = new ArrayList<AttributeType68664S>();
        }
