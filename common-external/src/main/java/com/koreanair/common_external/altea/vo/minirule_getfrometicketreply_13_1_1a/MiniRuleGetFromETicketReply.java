...
public class MiniRuleGetFromETicketReply {
    ...
    protected List<MnrByPricingRecord> mnrByPricingRecord;
     ...
     * {@link MnrByPricingRecord }
     * 
     * 
     */
    public List<MnrByPricingRecord> getMnrByPricingRecord() {
        if (mnrByPricingRecord == null) {
            mnrByPricingRecord = new ArrayList<MnrByPricingRecord>();
        }
    ...
    public static class MnrByPricingRecord {
        ...
        @XmlElement(required = true)
        protected List<FareComponentInfo> fareComponentInfo;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link FareComponentInfo }
         * 
         * 
         */
        public List<FareComponentInfo> getFareComponentInfo() {
            if (fareComponentInfo == null) {
                fareComponentInfo = new ArrayList<FareComponentInfo>();
            }
