 ...
 *       &lt;sequence>
 *         &lt;element name="chargeDetails" type="{http://xml.amadeus.com/TPSCGQ_12_3_1A}AssociatedChargesInformationType" maxOccurs="99" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TariffInformationType {
    ...
    protected List<AssociatedChargesInformationType> chargeDetails;
     ...
     * {@link AssociatedChargesInformationType }
     * 
     * 
     */
    public List<AssociatedChargesInformationType> getChargeDetails() {
        if (chargeDetails == null) {
            chargeDetails = new ArrayList<AssociatedChargesInformationType>();
        }
