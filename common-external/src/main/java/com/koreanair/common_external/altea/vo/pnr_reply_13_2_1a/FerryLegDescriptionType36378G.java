...
public class FerryLegDescriptionType36378G {
    ...
    protected List<PriceInfoGroup> priceInfoGroup;
    protected List<VehicleInfoGroup> vehicleInfoGroup;
    protected List<ServiceInfoGroup> serviceInfoGroup;
    protected List<AnimalInfoGroup> animalInfoGroup;
    ...
    public List<PriceInfoGroup> getPriceInfoGroup() {
        if (priceInfoGroup == null) {
            priceInfoGroup = new ArrayList<PriceInfoGroup>();
        }
