 ...
 *       &lt;sequence>
 *         &lt;element name="actionDetails" type="{http://xml.amadeus.com/TSRNRQ_10_1_1A}ActionDetailsTypeI" minOccurs="0"/>
 *         &lt;element name="agentUserDetails" type="{http://xml.amadeus.com/TSRNRQ_10_1_1A}UserIdentificationType" minOccurs="0"/>
 *         &lt;element name="currencyInfo" type="{http://xml.amadeus.com/TSRNRQ_10_1_1A}CurrenciesTypeU" minOccurs="0"/>
 *         &lt;element name="dateDetails" type="{http://xml.amadeus.com/TSRNRQ_10_1_1A}StructuredDateTimeInformationType" minOccurs="0"/>
 *         &lt;element name="agencyDetails" type="{http://xml.amadeus.com/TSRNRQ_10_1_1A}AdditionalBusinessSourceInformationTypeI" minOccurs="0"/>
 *         &lt;element name="requestOption" type="{http://xml.amadeus.com/TSRNRQ_10_1_1A}SelectionDetailsTypeI" minOccurs="0"/>
 *         &lt;element name="salesPeriodDetails" type="{http://xml.amadeus.com/TSRNRQ_10_1_1A}StructuredPeriodInformationType" minOccurs="0"/>
 *         &lt;element name="transactionTypeCodeInfo" type="{http://xml.amadeus.com/TSRNRQ_10_1_1A}TransactionInformationForTicketingType" maxOccurs="2" minOccurs="0"/>
 *         &lt;element name="fromSequenceDocumentNumber" type="{http://xml.amadeus.com/TSRNRQ_10_1_1A}ItemNumberTypeI" minOccurs="0"/>
 *         &lt;element name="documentInfo" type="{http://xml.amadeus.com/TSRNRQ_10_1_1A}StatusType" minOccurs="0"/>
 *         &lt;element name="validatingCarrierCode" type="{http://xml.amadeus.com/TSRNRQ_10_1_1A}TransportIdentifierType" minOccurs="0"/>
 *         &lt;element name="attributeInfo" type="{http://xml.amadeus.com/TSRNRQ_10_1_1A}CodedAttributeType" minOccurs="0"/>
 *         &lt;element name="formOfPaymentDetails" type="{http://xml.amadeus.com/TSRNRQ_10_1_1A}FormOfPaymentTypeI" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SalesReports_DisplayNetRemitReport")
public class SalesReportsDisplayNetRemitReport {
    ...
    protected List<TransactionInformationForTicketingType> transactionTypeCodeInfo;
    protected ItemNumberTypeI fromSequenceDocumentNumber;
    protected StatusType documentInfo;
    protected TransportIdentifierType validatingCarrierCode;
    ...
    /**
     * Gets the value of the transactionTypeCodeInfo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the transactionTypeCodeInfo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTransactionTypeCodeInfo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<TransactionInformationForTicketingType> getTransactionTypeCodeInfo() {
        if (transactionTypeCodeInfo == null) {
            transactionTypeCodeInfo = new ArrayList<TransactionInformationForTicketingType>();
        }
        return this.transactionTypeCodeInfo;
    }
     ...
     *     
     */
    public StatusType getDocumentInfo() {
        return documentInfo;
    }
     ...
     *     
     */
    public void setDocumentInfo(StatusType value) {
     ...
     *     
     */
    public TransportIdentifierType getValidatingCarrierCode() {
     ...
     *     
     */
    public void setValidatingCarrierCode(TransportIdentifierType value) {
