 ...
 *       &lt;sequence>
 *         &lt;element name="itemNumberDetails" type="{http://xml.amadeus.com/TPSCGR_12_3_1A}ItemNumberIdentificationType_213249C" maxOccurs="3"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ItemNumberType {
    ...
    protected List<ItemNumberIdentificationType213249C> itemNumberDetails;
     ...
     * {@link ItemNumberIdentificationType213249C }
     * 
     * 
     */
    public List<ItemNumberIdentificationType213249C> getItemNumberDetails() {
        if (itemNumberDetails == null) {
            itemNumberDetails = new ArrayList<ItemNumberIdentificationType213249C>();
        }
