...
public class SalesReportsDisplayQueryReportReply {
    ...
    protected QueryReportDataDetails queryReportDataDetails;
     ...
     * @return
     *     possible object is
     *     {@link QueryReportDataDetails }
     *     
     */
    public QueryReportDataDetails getQueryReportDataDetails() {
     ...
     *     
     */
    public void setQueryReportDataDetails(QueryReportDataDetails value) {
    ...
    public static class QueryReportDataDetails {
        ...
        @XmlElement(required = true)
        protected List<QueryReportDataOfficeGroup> queryReportDataOfficeGroup;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link QueryReportDataOfficeGroup }
         * 
         * 
         */
        public List<QueryReportDataOfficeGroup> getQueryReportDataOfficeGroup() {
            if (queryReportDataOfficeGroup == null) {
                queryReportDataOfficeGroup = new ArrayList<QueryReportDataOfficeGroup>();
            }
