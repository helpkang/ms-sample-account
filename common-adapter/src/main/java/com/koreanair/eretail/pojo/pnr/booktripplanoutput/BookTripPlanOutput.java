    ...
    implements Serializable
{
    ...
    protected com.koreanair.eretail.pojo.tripplan.status.STATUS status;
    ...
    protected List<com.koreanair.eretail.pojo.tripplan.hotel.HOTEL> hotel;
     ...
     * @return
     *     possible object is
     *     {@link com.koreanair.eretail.pojo.tripplan.status.STATUS }
     *     
     */
    public com.koreanair.eretail.pojo.tripplan.status.STATUS getSTATUS() {
        return status;
    }
     ...
     *     
     */
    public void setSTATUS(com.koreanair.eretail.pojo.tripplan.status.STATUS value) {
        this.status = value;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link com.koreanair.eretail.pojo.tripplan.hotel.HOTEL }
     * 
     * 
     */
    public List<com.koreanair.eretail.pojo.tripplan.hotel.HOTEL> getHOTEL() {
        if (hotel == null) {
            hotel = new ArrayList<com.koreanair.eretail.pojo.tripplan.hotel.HOTEL>();
        }
        return this.hotel;
    }
