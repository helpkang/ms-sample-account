...
package com.koreanair.eretail.pojo.air.selectflightandcontinueinput;
 ...
 *               &lt;enumeration value="AirSelectFlightAndContinue"/&gt;
 *               &lt;enumeration value="AirSelectFlightAndContinueForRebooking"/&gt;
 *             &lt;/restriction&gt;
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element ref="{}LIST_SELECTED" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{}LIST_SELECTION_UPDATE" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{}SITE"/&gt;
...
@XmlRootElement(name = "SelectFlightAndContinueInput")
public class SelectFlightAndContinueInput
    implements Serializable
{

    @XmlElement(name = "TRANSACTION_ID", required = true)
    protected String transactionid;
    @XmlElement(name = "LIST_SELECTED")
    protected List<BigInteger> listselected;
    @XmlElement(name = "LIST_SELECTION_UPDATE")
    protected List<SELECTIONUPDATEType> listselectionupdate;
    ...
    protected SelectFlightAndContinueInput.REQUESTINFO requestinfo;
    ...
    protected List<SelectFlightAndContinueInput.APISCHECKSTRUCTUREPASSENGER> apischeckstructurepassenger;
    @XmlAnyAttribute
    ...
    /**
     * Gets the value of the listselected property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the listselected property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLISTSELECTED().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BigInteger> getLISTSELECTED() {
        if (listselected == null) {
            listselected = new ArrayList<BigInteger>();
        }
        return this.listselected;
    }

    /**
     * Gets the value of the listselectionupdate property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the listselectionupdate property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLISTSELECTIONUPDATE().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SELECTIONUPDATEType }
     * 
     * 
     */
    public List<SELECTIONUPDATEType> getLISTSELECTIONUPDATE() {
        if (listselectionupdate == null) {
            listselectionupdate = new ArrayList<SELECTIONUPDATEType>();
        }
        return this.listselectionupdate;
    }
     ...
     * @return
     *     possible object is
     *     {@link SelectFlightAndContinueInput.REQUESTINFO }
     *     
     */
    public SelectFlightAndContinueInput.REQUESTINFO getREQUESTINFO() {
        return requestinfo;
    }
     ...
     *     
     */
    public void setREQUESTINFO(SelectFlightAndContinueInput.REQUESTINFO value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SelectFlightAndContinueInput.APISCHECKSTRUCTUREPASSENGER }
     * 
     * 
     */
    public List<SelectFlightAndContinueInput.APISCHECKSTRUCTUREPASSENGER> getAPISCHECKSTRUCTUREPASSENGER() {
        if (apischeckstructurepassenger == null) {
            apischeckstructurepassenger = new ArrayList<SelectFlightAndContinueInput.APISCHECKSTRUCTUREPASSENGER>();
        }
