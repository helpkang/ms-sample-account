...
/**
 * The type representing the type of address.Possible types are P (Personal), Z (Business), B (Billing), D (Delivery), I (Invoicing), A (Agency), C (Customer), O (other), M (Mailing)
 * 
 * <p>Java class for ADDRESS_TYPE_APIS_PFIELD complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ADDRESS_TYPE_APIS_PFIELD"&gt;
 *   &lt;simpleContent&gt;
 *     &lt;extension base="&lt;&gt;ADDRESS_TYPE_PFIELD"&gt;
...
@XmlType(name = "ADDRESS_TYPE_APIS_PFIELD")
public class ADDRESSTYPEAPISPFIELD
    extends ADDRESSTYPEPFIELD
