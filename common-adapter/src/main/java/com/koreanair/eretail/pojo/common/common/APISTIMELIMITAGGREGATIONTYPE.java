...
/**
 * <p>Java class for APIS_TIME_LIMIT_AGGREGATION_TYPE complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="APIS_TIME_LIMIT_AGGREGATION_TYPE"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;group ref="{}APIS_TIME_LIMIT_DESCRIPTION_GROUP" minOccurs="0"/&gt;
 *         &lt;element name="LIST_TIME_LIMIT" type="{}APIS_TIME_LIMIT_TYPE" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "APIS_TIME_LIMIT_AGGREGATION_TYPE", propOrder = {
    "referencedate",
    "limitdate",
    "requirement",
    "timelimit",
...
public class APISTIMELIMITAGGREGATIONTYPE
    implements Serializable
{
    ...
    protected List<APISTIMELIMITTYPE> listtimelimit;
     ...
     * {@link APISTIMELIMITTYPE }
     * 
     * 
     */
    public List<APISTIMELIMITTYPE> getLISTTIMELIMIT() {
        if (listtimelimit == null) {
            listtimelimit = new ArrayList<APISTIMELIMITTYPE>();
        }
