 ...
 * 			
 * 
 * <p>Java class for LIST_APPLIED_PRICING_OPTIONS_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LIST_APPLIED_PRICING_OPTIONS_Type"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{}COMMAND_EXECUTION_STATUS"/&gt;
 *         &lt;group ref="{}RequestedFareOptionsGroup"/&gt;
 *         &lt;element name="PRICING_OPTIONS_SOURCE_TYPE" type="{}PricingOptionsSourceType" minOccurs="0"/&gt;
 *         &lt;element name="IS_PENALTY_WAIVED" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/&gt;
 *         &lt;element name="CEM" type="{}CEM_Type" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "LIST_APPLIED_PRICING_OPTIONS_Type", propOrder = {
    ...
    "listupselllevel",
    "pricingoptionssourcetype",
    "ispenaltywaived",
    "cem"
})
public class LISTAPPLIEDPRICINGOPTIONSType
    implements Serializable
{

    @XmlElement(name = "COMMAND_EXECUTION_STATUS", required = true)
    protected String commandexecutionstatus;
    ...
    protected List<com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTCARRIERAGREEMENT> listcarrieragreement;
    ...
    protected List<com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTTRAVELLERSEGMENTOPTIONS> listtravellersegmentoptions;
    @XmlElement(name = "LIST_TRAVELLER_SEGMENT_OPTIONS_ATC")
    protected List<com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTTRAVELLERSEGMENTOPTIONSATC> listtravellersegmentoptionsatc;
    ...
    protected com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTSEGMENTPRICINGOPTIONS listsegmentpricingoptions;
    ...
    @XmlElement(name = "PRICING_OPTIONS_SOURCE_TYPE")
    @XmlSchemaType(name = "string")
    protected PricingOptionsSourceType pricingoptionssourcetype;
    @XmlElement(name = "IS_PENALTY_WAIVED")
    protected Boolean ispenaltywaived;
    @XmlElement(name = "CEM")
    protected CEMType cem;

    /**
     * CR 3174432 : the flag showing if element of requested options list is selected for further usage.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getCOMMANDEXECUTIONSTATUS() {
     ...
     *     
     */
    public void setCOMMANDEXECUTIONSTATUS(String value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTCARRIERAGREEMENT }
     * 
     * 
     */
    public List<com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTCARRIERAGREEMENT> getLISTCARRIERAGREEMENT() {
        if (listcarrieragreement == null) {
            listcarrieragreement = new ArrayList<com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTCARRIERAGREEMENT>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTTRAVELLERSEGMENTOPTIONS }
     * 
     * 
     */
    public List<com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTTRAVELLERSEGMENTOPTIONS> getLISTTRAVELLERSEGMENTOPTIONS() {
        if (listtravellersegmentoptions == null) {
            listtravellersegmentoptions = new ArrayList<com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTTRAVELLERSEGMENTOPTIONS>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTTRAVELLERSEGMENTOPTIONSATC }
     * 
     * 
     */
    public List<com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTTRAVELLERSEGMENTOPTIONSATC> getLISTTRAVELLERSEGMENTOPTIONSATC() {
        if (listtravellersegmentoptionsatc == null) {
            listtravellersegmentoptionsatc = new ArrayList<com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTTRAVELLERSEGMENTOPTIONSATC>();
        }
     ...
     * @return
     *     possible object is
     *     {@link com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTSEGMENTPRICINGOPTIONS }
     *     
     */
    public com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTSEGMENTPRICINGOPTIONS getLISTSEGMENTPRICINGOPTIONS() {
     ...
     *     
     */
    public void setLISTSEGMENTPRICINGOPTIONS(com.koreanair.eretail.pojo.farecommon.farecontext.LISTPRICINGOPTIONSInputType.LISTSEGMENTPRICINGOPTIONS value) {
    ...
    /**
     * Gets the value of the pricingoptionssourcetype property.
     * 
     * @return
     *     possible object is
     *     {@link PricingOptionsSourceType }
     *     
     */
    public PricingOptionsSourceType getPRICINGOPTIONSSOURCETYPE() {
        return pricingoptionssourcetype;
    }

    /**
     * Sets the value of the pricingoptionssourcetype property.
     * 
     * @param value
     *     allowed object is
     *     {@link PricingOptionsSourceType }
     *     
     */
    public void setPRICINGOPTIONSSOURCETYPE(PricingOptionsSourceType value) {
        this.pricingoptionssourcetype = value;
    }
     ...
     *     
     */
    public Boolean isISPENALTYWAIVED() {
     ...
     *     
     */
    public void setISPENALTYWAIVED(Boolean value) {
     ...
     *     
     */
    public void setCEM(CEMType value) {
        this.cem = value;
    }
