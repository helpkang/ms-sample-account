 ...
 *         &lt;element name="LIST_SEGMENT" type="{}SEGMENT_RESPONSE_type" maxOccurs="unbounded" minOccurs="0"/&gt;
    ...
    implements Serializable
{
    ...
    protected List<SEGMENTRESPONSEType> listsegment;
     ...
     * 
     */
    public List<SEGMENTRESPONSEType> getLISTSEGMENT() {
        if (listsegment == null) {
            listsegment = new ArrayList<SEGMENTRESPONSEType>();
        }
