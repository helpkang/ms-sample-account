...
package com.koreanair.external.eretail.vo.air.selectmodifiedflightinput;
...
@XmlRootElement(name = "SelectModifiedFlightInput")
public class SelectModifiedFlightInput
    implements Serializable
{
    ...
    protected SelectModifiedFlightInput.REQUESTINFO requestinfo;
    ...
    protected List<SelectModifiedFlightInput.APISCHECKSTRUCTUREPASSENGER> apischeckstructurepassenger;
    @XmlAnyAttribute
     ...
     * @return
     *     possible object is
     *     {@link SelectModifiedFlightInput.REQUESTINFO }
     *     
     */
    public SelectModifiedFlightInput.REQUESTINFO getREQUESTINFO() {
        return requestinfo;
    }
     ...
     *     
     */
    public void setREQUESTINFO(SelectModifiedFlightInput.REQUESTINFO value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SelectModifiedFlightInput.APISCHECKSTRUCTUREPASSENGER }
     * 
     * 
     */
    public List<SelectModifiedFlightInput.APISCHECKSTRUCTUREPASSENGER> getAPISCHECKSTRUCTUREPASSENGER() {
        if (apischeckstructurepassenger == null) {
            apischeckstructurepassenger = new ArrayList<SelectModifiedFlightInput.APISCHECKSTRUCTUREPASSENGER>();
        }
