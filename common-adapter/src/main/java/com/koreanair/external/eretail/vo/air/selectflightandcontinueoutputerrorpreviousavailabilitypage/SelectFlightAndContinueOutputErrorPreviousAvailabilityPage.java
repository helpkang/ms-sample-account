 ...
 *         &lt;element ref="{}LIST_AVAILABILITY" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "SelectFlightAndContinueOutputErrorPreviousAvailabilityPage")
public class SelectFlightAndContinueOutputErrorPreviousAvailabilityPage
    implements Serializable
{
    ...
    @XmlElement(name = "LIST_AVAILABILITY")
