 ...
 * 
 * <p>Java class for STRING_TYPE_PFIELD complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="STRING_TYPE_PFIELD"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "STRING_TYPE_PFIELD", propOrder = {
    "value"
})
@XmlSeeAlso({
    com.koreanair.external.eretail.vo.profile.commonprofileout.ADDRESSINFORMATIONTYPE.FIRSTNAME.class,
    com.koreanair.external.eretail.vo.profile.commonprofileout.ADDRESSINFORMATIONTYPE.LASTNAME.class,
    STRINGTYPEAPISPFIELD.class,
    STRINGTYPENATIONALITYPFIELD.class,
    ADDRESSTYPEPFIELD.class
})
public class STRINGTYPEPFIELD
