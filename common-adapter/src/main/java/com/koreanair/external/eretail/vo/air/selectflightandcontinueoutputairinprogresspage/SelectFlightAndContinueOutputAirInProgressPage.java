...
@XmlRootElement(name = "SelectFlightAndContinueOutputAirInProgressPage")
public class SelectFlightAndContinueOutputAirInProgressPage
    implements Serializable
{
    ...
    protected SelectFlightAndContinueOutputAirInProgressPage.TRAVELSPONSOR travelsponsor;
    @XmlAnyAttribute
     ...
     * @return
     *     possible object is
     *     {@link SelectFlightAndContinueOutputAirInProgressPage.TRAVELSPONSOR }
     *     
     */
    public SelectFlightAndContinueOutputAirInProgressPage.TRAVELSPONSOR getTRAVELSPONSOR() {
     ...
     *     
     */
    public void setTRAVELSPONSOR(SelectFlightAndContinueOutputAirInProgressPage.TRAVELSPONSOR value) {
