    ...
    implements Serializable
{
    ...
    protected List<HOTEL.LISTTRAVELLERID> listtravellerid;
    @XmlAnyAttribute
     ...
     * {@link HOTEL.LISTTRAVELLERID }
     * 
     * 
     */
    public List<HOTEL.LISTTRAVELLERID> getLISTTRAVELLERID() {
        if (listtravellerid == null) {
            listtravellerid = new ArrayList<HOTEL.LISTTRAVELLERID>();
        }
