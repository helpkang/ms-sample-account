...
package com.koreanair.external.eretail.vo.pnr.miscinput;
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="MISC_TYPE" type="{http://www.w3.org/2001/XMLSchema}anyType"/&gt;
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "MISC_TYPE", required = true)
    protected Object misctype;
    @XmlElement(name = "ITEM_ID", required = true)
    protected Object itemid;
    @XmlElement(name = "LIST_TRAVELLER_ID", required = true)
    protected List<MISC.LISTTRAVELLERID> listtravellerid;
    @XmlAnyAttribute
     ...
     *     
     */
    public void setMISCTYPE(Object value) {
        this.misctype = value;
    }
     ...
     * {@link MISC.LISTTRAVELLERID }
     * 
     * 
     */
    public List<MISC.LISTTRAVELLERID> getLISTTRAVELLERID() {
        if (listtravellerid == null) {
            listtravellerid = new ArrayList<MISC.LISTTRAVELLERID>();
        }
