...
/**
 * <p>Java class for BOOKED_TRIP_FARE_FLEX_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BOOKED_TRIP_FARE_FLEX_Type"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="LIST_TRIP_PRICE" type="{}BOOKED_LIST_TRIP_PRICE_Type" maxOccurs="unbounded"/&gt;
 *         &lt;element name="LIST_PNR" type="{}BOOKED_LIST_PNR_FLEX_Type" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "BOOKED_TRIP_FARE_FLEX_Type", propOrder = {
    "listtripprice",
    "listpnr",
    "listredemption"
})
public class BOOKEDTRIPFAREFLEXType
    implements Serializable
{
    ...
    protected List<BOOKEDLISTPNRFLEXType> listpnr;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BOOKEDLISTPNRFLEXType }
     * 
     * 
     */
    public List<BOOKEDLISTPNRFLEXType> getLISTPNR() {
        if (listpnr == null) {
            listpnr = new ArrayList<BOOKEDLISTPNRFLEXType>();
        }
        return this.listpnr;
    }
