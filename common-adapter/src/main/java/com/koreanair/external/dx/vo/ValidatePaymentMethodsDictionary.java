...
public class ValidatePaymentMethodsDictionary  {
  ...
  **/
  ...
  public ValidatePaymentMethodsDictionary location(Map<String, LocationDictionaryItem> location) {
    this.location = location;
    return this;
  }

  public ValidatePaymentMethodsDictionary putLocationItem(String key, LocationDictionaryItem locationItem) {
  ...
  **/
  ...
  public ValidatePaymentMethodsDictionary country(Map<String, String> country) {
    this.country = country;
    return this;
  }

  public ValidatePaymentMethodsDictionary putCountryItem(String key, String countryItem) {
  ...
  **/
  ...
  public ValidatePaymentMethodsDictionary airline(Map<String, String> airline) {
    this.airline = airline;
    return this;
  }

  public ValidatePaymentMethodsDictionary putAirlineItem(String key, String airlineItem) {
  ...
  **/
  ...
  public ValidatePaymentMethodsDictionary aircraft(Map<String, String> aircraft) {
    this.aircraft = aircraft;
    return this;
  }

  public ValidatePaymentMethodsDictionary putAircraftItem(String key, String aircraftItem) {
  ...
  **/
  ...
  public ValidatePaymentMethodsDictionary flight(Map<String, Flight> flight) {
    this.flight = flight;
    return this;
  }

  public ValidatePaymentMethodsDictionary putFlightItem(String key, Flight flightItem) {
  ...
  **/
  ...
  public ValidatePaymentMethodsDictionary tax(Map<String, String> tax) {
    this.tax = tax;
    return this;
  }

  public ValidatePaymentMethodsDictionary putTaxItem(String key, String taxItem) {
  ...
  **/
  ...
  public ValidatePaymentMethodsDictionary surcharge(Map<String, String> surcharge) {
    this.surcharge = surcharge;
    return this;
  }

  public ValidatePaymentMethodsDictionary putSurchargeItem(String key, String surchargeItem) {
  ...
  **/
  ...
  public ValidatePaymentMethodsDictionary currency(Map<String, CurrencyDictionaryItem> currency) {
    this.currency = currency;
    return this;
  }

  public ValidatePaymentMethodsDictionary putCurrencyItem(String key, CurrencyDictionaryItem currencyItem) {
  ...
  **/
  ...
  public ValidatePaymentMethodsDictionary anonymousTraveler(Map<String, AnonymousTraveler> anonymousTraveler) {
    this.anonymousTraveler = anonymousTraveler;
    return this;
  }

  public ValidatePaymentMethodsDictionary putAnonymousTravelerItem(String key, AnonymousTraveler anonymousTravelerItem) {
  ...
  **/
  ...
  public ValidatePaymentMethodsDictionary discount(Map<String, DiscountDictionaryItem> discount) {
    this.discount = discount;
    return this;
  }

  public ValidatePaymentMethodsDictionary putDiscountItem(String key, DiscountDictionaryItem discountItem) {
  ...
  **/
  ...
  public ValidatePaymentMethodsDictionary traveler(Map<String, Traveler> traveler) {
    this.traveler = traveler;
    return this;
  }

  public ValidatePaymentMethodsDictionary putTravelerItem(String key, Traveler travelerItem) {
  ...
  **/
  ...
  public ValidatePaymentMethodsDictionary seatCharacteristic(Map<String, SeatCharacteristicDictionaryItem> seatCharacteristic) {
    this.seatCharacteristic = seatCharacteristic;
    return this;
  }

  public ValidatePaymentMethodsDictionary putSeatCharacteristicItem(String key, SeatCharacteristicDictionaryItem seatCharacteristicItem) {
  ...
  public String toString() {
    ...
    sb.append("class ValidatePaymentMethodsDictionary {\n");
