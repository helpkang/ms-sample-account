...
/**
  * Extension item
 **/
@ApiModel(description="Extension item")
public class ExtensionReply  {
  ...
  **/
  ...
  public ExtensionReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public ExtensionReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public ExtensionReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public ExtensionReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  ...
  public void setData(Extension data) {
    this.data = data;
  }

  public ExtensionReply data(Extension data) {
    this.data = data;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class ExtensionReply {\n");
