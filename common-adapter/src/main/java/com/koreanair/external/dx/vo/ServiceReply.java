...
public class ServiceReply  {
  ...
  **/
  ...
  public ServiceReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public ServiceReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public ServiceReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public ServiceReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  ...
  public void setData(ServiceItem data) {
    this.data = data;
  }

  public ServiceReply data(ServiceItem data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public ServiceReply dictionaries(DictionaryCommon dictionaries) {
    this.dictionaries = dictionaries;
    return this;
  }
