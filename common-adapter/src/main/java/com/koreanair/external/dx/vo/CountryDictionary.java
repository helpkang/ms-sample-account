...
public class CountryDictionary  {
  ...
  **/
  ...
  public CountryDictionary location(Map<String, LocationDictionaryItem> location) {
    this.location = location;
    return this;
  }

  public CountryDictionary putLocationItem(String key, LocationDictionaryItem locationItem) {
  ...
  **/
  ...
  public CountryDictionary country(Map<String, String> country) {
    this.country = country;
    return this;
  }

  public CountryDictionary putCountryItem(String key, String countryItem) {
  ...
  public String toString() {
    ...
    sb.append("class CountryDictionary {\n");
