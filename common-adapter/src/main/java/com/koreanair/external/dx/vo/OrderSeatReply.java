...
/**
  * Reply containing a seat object. 
 **/
@ApiModel(description="Reply containing a seat object. ")
public class OrderSeatReply  {
  ...
  **/
  ...
  private OrderSeatItem data = null;
  ...
  **/
  ...
  public OrderSeatReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public OrderSeatReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public OrderSeatReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public OrderSeatReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  @JsonProperty("data")
  public OrderSeatItem getData() {
    return data;
  }

  public void setData(OrderSeatItem data) {
    this.data = data;
  }

  public OrderSeatReply data(OrderSeatItem data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public OrderSeatReply links(List<HttpRequest> links) {
    this.links = links;
    return this;
  }

  public OrderSeatReply addLinksItem(HttpRequest linksItem) {
  ...
  **/
  ...
  public OrderSeatReply dictionaries(DictionaryCommon dictionaries) {
    this.dictionaries = dictionaries;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderSeatReply {\n");
