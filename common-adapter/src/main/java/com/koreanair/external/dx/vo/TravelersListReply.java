...
public class TravelersListReply  {
  ...
  **/
  ...
  private List<Traveler> data = new ArrayList<>();
  ...
  **/
  ...
  public TravelersListReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public TravelersListReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public TravelersListReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public TravelersListReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  @JsonProperty("data")
  public List<Traveler> getData() {
    return data;
  }

  public void setData(List<Traveler> data) {
    this.data = data;
  }

  public TravelersListReply data(List<Traveler> data) {
    this.data = data;
    return this;
  }

  public TravelersListReply addDataItem(Traveler dataItem) {
  ...
  **/
  ...
  public TravelersListReply dictionaries(Object dictionaries) {
    this.dictionaries = dictionaries;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class TravelersListReply {\n");
