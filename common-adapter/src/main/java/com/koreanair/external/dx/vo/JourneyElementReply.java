...
public class JourneyElementReply  {
  ...
  **/
  ...
  private JourneyElement data = null;
  ...
  **/
  ...
  public JourneyElementReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public JourneyElementReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public JourneyElementReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public JourneyElementReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  @JsonProperty("data")
  public JourneyElement getData() {
    return data;
  }

  public void setData(JourneyElement data) {
    this.data = data;
  }

  public JourneyElementReply data(JourneyElement data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public JourneyElementReply dictionaries(JourneyElementDictionary dictionaries) {
    this.dictionaries = dictionaries;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class JourneyElementReply {\n");
