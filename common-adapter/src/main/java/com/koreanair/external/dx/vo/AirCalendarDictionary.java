...
public class AirCalendarDictionary  {
  ...
  **/
  ...
  @ApiModelProperty(value = "Fare families with services map. For more details please see [Maps in dictionary documentation](http://e-travel.mkt.amadeus.net/dxapi/display/documentation.html#!/Maps/get) ")
 /**
   * Fare families with services map. For more details please see [Maps in dictionary documentation](http://e-travel.mkt.amadeus.net/dxapi/display/documentation.html#!/Maps/get) 
  **/
  private Map<String, FareFamilyWithServicesDictionaryItem> fareFamilyWithServices = null;

  @ApiModelProperty(value = "Provides explanations for travel solution unavailability reason codes ")
 /**
   * Provides explanations for travel solution unavailability reason codes 
  **/
  ...
  **/
  ...
  public AirCalendarDictionary location(Map<String, LocationDictionaryItem> location) {
    this.location = location;
    return this;
  }

  public AirCalendarDictionary putLocationItem(String key, LocationDictionaryItem locationItem) {
  ...
  **/
  ...
  public AirCalendarDictionary country(Map<String, String> country) {
    this.country = country;
    return this;
  }

  public AirCalendarDictionary putCountryItem(String key, String countryItem) {
  ...
  **/
  ...
  public AirCalendarDictionary airline(Map<String, String> airline) {
    this.airline = airline;
    return this;
  }

  public AirCalendarDictionary putAirlineItem(String key, String airlineItem) {
  ...
  **/
  ...
  public AirCalendarDictionary aircraft(Map<String, String> aircraft) {
    this.aircraft = aircraft;
    return this;
  }

  public AirCalendarDictionary putAircraftItem(String key, String aircraftItem) {
  ...
  **/
  ...
  public AirCalendarDictionary flight(Map<String, Flight> flight) {
    this.flight = flight;
    return this;
  }

  public AirCalendarDictionary putFlightItem(String key, Flight flightItem) {
  ...
  **/
  ...
  public AirCalendarDictionary tax(Map<String, String> tax) {
    this.tax = tax;
    return this;
  }

  public AirCalendarDictionary putTaxItem(String key, String taxItem) {
  ...
  **/
  ...
  public AirCalendarDictionary surcharge(Map<String, String> surcharge) {
    this.surcharge = surcharge;
    return this;
  }

  public AirCalendarDictionary putSurchargeItem(String key, String surchargeItem) {
  ...
  **/
  ...
  public AirCalendarDictionary currency(Map<String, CurrencyDictionaryItem> currency) {
    this.currency = currency;
    return this;
  }

  public AirCalendarDictionary putCurrencyItem(String key, CurrencyDictionaryItem currencyItem) {
  ...
  **/
  ...
  public AirCalendarDictionary anonymousTraveler(Map<String, AnonymousTraveler> anonymousTraveler) {
    this.anonymousTraveler = anonymousTraveler;
    return this;
  }

  public AirCalendarDictionary putAnonymousTravelerItem(String key, AnonymousTraveler anonymousTravelerItem) {
  ...
  **/
  ...
  public AirCalendarDictionary discount(Map<String, DiscountDictionaryItem> discount) {
    this.discount = discount;
    return this;
  }

  public AirCalendarDictionary putDiscountItem(String key, DiscountDictionaryItem discountItem) {
  ...
  **/
  ...
  public AirCalendarDictionary traveler(Map<String, Traveler> traveler) {
    this.traveler = traveler;
    return this;
  }

  public AirCalendarDictionary putTravelerItem(String key, Traveler travelerItem) {
  ...
  **/
  ...
  public AirCalendarDictionary seatCharacteristic(Map<String, SeatCharacteristicDictionaryItem> seatCharacteristic) {
    this.seatCharacteristic = seatCharacteristic;
    return this;
  }

  public AirCalendarDictionary putSeatCharacteristicItem(String key, SeatCharacteristicDictionaryItem seatCharacteristicItem) {
 ...
 /**
   * Fare families with services map. For more details please see [Maps in dictionary documentation](http://e-travel.mkt.amadeus.net/dxapi/display/documentation.html#!/Maps/get) 
   * @return fareFamilyWithServices
  **/
  @JsonProperty("fareFamilyWithServices")
  public Map<String, FareFamilyWithServicesDictionaryItem> getFareFamilyWithServices() {
    return fareFamilyWithServices;
  }

  public void setFareFamilyWithServices(Map<String, FareFamilyWithServicesDictionaryItem> fareFamilyWithServices) {
    this.fareFamilyWithServices = fareFamilyWithServices;
  }

  public AirCalendarDictionary fareFamilyWithServices(Map<String, FareFamilyWithServicesDictionaryItem> fareFamilyWithServices) {
    this.fareFamilyWithServices = fareFamilyWithServices;
    return this;
  }

  public AirCalendarDictionary putFareFamilyWithServicesItem(String key, FareFamilyWithServicesDictionaryItem fareFamilyWithServicesItem) {
    this.fareFamilyWithServices.put(key, fareFamilyWithServicesItem);
    return this;
  }
  ...
  **/
  ...
  public void setUnavailabilityReason(Map<String, String> unavailabilityReason) {
    this.unavailabilityReason = unavailabilityReason;
  }

  public AirCalendarDictionary unavailabilityReason(Map<String, String> unavailabilityReason) {
    this.unavailabilityReason = unavailabilityReason;
    return this;
  }

  public AirCalendarDictionary putUnavailabilityReasonItem(String key, String unavailabilityReasonItem) {
    this.unavailabilityReason.put(key, unavailabilityReasonItem);
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class AirCalendarDictionary {\n");
    ...
    sb.append("    fareFamilyWithServices: ").append(toIndentedString(fareFamilyWithServices)).append("\n");
