...
public class PaymentCurrencyConversionDictionary  {
  ...
  **/
  ...
  public PaymentCurrencyConversionDictionary currency(Map<String, CurrencyDictionaryItem> currency) {
    this.currency = currency;
    return this;
  }

  public PaymentCurrencyConversionDictionary putCurrencyItem(String key, CurrencyDictionaryItem currencyItem) {
  ...
  **/
  ...
  public PaymentCurrencyConversionDictionary airline(Map<String, String> airline) {
    this.airline = airline;
    return this;
  }

  public PaymentCurrencyConversionDictionary putAirlineItem(String key, String airlineItem) {
  ...
  public String toString() {
    ...
    sb.append("class PaymentCurrencyConversionDictionary {\n");
