...
public class SeatReply  {
  ...
  **/
  ...
  public SeatReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public SeatReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public SeatReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public SeatReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  ...
  public SeatReply data(SeatItem data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public SeatReply dictionaries(DictionaryCommon dictionaries) {
    this.dictionaries = dictionaries;
    return this;
  }
