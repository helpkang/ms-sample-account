...
public class CommonReply  {
  ...
  **/
  ...
  public CommonReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public CommonReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public CommonReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public CommonReply addWarningsItem(WarningMessage warningsItem) {
