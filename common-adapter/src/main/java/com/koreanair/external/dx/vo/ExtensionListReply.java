...
/**
  * List of extensions
 **/
@ApiModel(description="List of extensions")
public class ExtensionListReply  {
  ...
  **/
  ...
  private List<Extension> data = new ArrayList<>();
 /**
   * Array of error messages
   * @return errors
  **/
  ...
  public ExtensionListReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public ExtensionListReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public ExtensionListReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public ExtensionListReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  ...
  public ExtensionListReply data(List<Extension> data) {
    this.data = data;
    return this;
  }

  public ExtensionListReply addDataItem(Extension dataItem) {
  ...
  public String toString() {
    ...
    sb.append("class ExtensionListReply {\n");
