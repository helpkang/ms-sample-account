...
public class FlightDictionary  {
  ...
  **/
  ...
  public FlightDictionary location(Map<String, LocationDictionaryItem> location) {
    this.location = location;
    return this;
  }

  public FlightDictionary putLocationItem(String key, LocationDictionaryItem locationItem) {
  ...
  **/
  ...
  public FlightDictionary country(Map<String, String> country) {
    this.country = country;
    return this;
  }

  public FlightDictionary putCountryItem(String key, String countryItem) {
  ...
  **/
  ...
  public FlightDictionary airline(Map<String, String> airline) {
    this.airline = airline;
    return this;
  }

  public FlightDictionary putAirlineItem(String key, String airlineItem) {
  ...
  **/
  ...
  public FlightDictionary aircraft(Map<String, String> aircraft) {
    this.aircraft = aircraft;
    return this;
  }

  public FlightDictionary putAircraftItem(String key, String aircraftItem) {
  ...
  **/
  ...
  public FlightDictionary flight(Map<String, Flight> flight) {
    this.flight = flight;
    return this;
  }

  public FlightDictionary putFlightItem(String key, Flight flightItem) {
  ...
  public String toString() {
    ...
    sb.append("class FlightDictionary {\n");
