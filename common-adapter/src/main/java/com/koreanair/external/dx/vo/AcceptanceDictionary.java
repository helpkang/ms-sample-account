...
public class AcceptanceDictionary  {
  ...
  **/
  ...
  public AcceptanceDictionary flight(Map<String, CheckInFlight> flight) {
    this.flight = flight;
    return this;
  }

  public AcceptanceDictionary putFlightItem(String key, CheckInFlight flightItem) {
  ...
  **/
  ...
  public AcceptanceDictionary airline(Map<String, String> airline) {
    this.airline = airline;
    return this;
  }

  public AcceptanceDictionary putAirlineItem(String key, String airlineItem) {
  ...
  **/
  ...
  public AcceptanceDictionary aircraft(Map<String, String> aircraft) {
    this.aircraft = aircraft;
    return this;
  }

  public AcceptanceDictionary putAircraftItem(String key, String aircraftItem) {
  ...
  **/
  ...
  public AcceptanceDictionary location(Map<String, LocationDictionaryItem> location) {
    this.location = location;
    return this;
  }

  public AcceptanceDictionary putLocationItem(String key, LocationDictionaryItem locationItem) {
  ...
  **/
  ...
  public AcceptanceDictionary country(Map<String, String> country) {
    this.country = country;
    return this;
  }

  public AcceptanceDictionary putCountryItem(String key, String countryItem) {
  ...
  **/
  ...
  public AcceptanceDictionary traveler(Map<String, Traveler> traveler) {
    this.traveler = traveler;
    return this;
  }

  public AcceptanceDictionary putTravelerItem(String key, Traveler travelerItem) {
  ...
  **/
  ...
  public AcceptanceDictionary journeyElement(Map<String, JourneyElement> journeyElement) {
    this.journeyElement = journeyElement;
    return this;
  }

  public AcceptanceDictionary putJourneyElementItem(String key, JourneyElement journeyElementItem) {
  ...
  public String toString() {
    ...
    sb.append("class AcceptanceDictionary {\n");
