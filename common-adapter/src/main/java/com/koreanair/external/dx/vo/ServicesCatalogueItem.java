...
import com.koreanair.external.dx.vo.ServiceCataloguePricingRecords;
...
public class ServicesCatalogueItem  {
  ...
  **/
  private ServiceCataloguePricingRecords prices = null;

  @ApiModelProperty(value = "Travelers associated to this service. The traveler id refers to the traveler dictionary. ")
 /**
   * Travelers associated to this service. The traveler id refers to the traveler dictionary. 
  **/
  ...
  **/
  ...
  public ServicesCatalogueItem id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ServicesCatalogueItem tid(String tid) {
    this.tid = tid;
    return this;
  }
  ...
  **/
  ...
  public ServicesCatalogueItem descriptions(List<ServiceDescription> descriptions) {
    this.descriptions = descriptions;
    return this;
  }

  public ServicesCatalogueItem addDescriptionsItem(ServiceDescription descriptionsItem) {
  ...
  **/
  ...
  public ServicesCatalogueItem quantity(Integer quantity) {
    this.quantity = quantity;
    return this;
  }
  ...
  **/
  ...
  public ServicesCatalogueItem quota(Integer quota) {
    this.quota = quota;
    return this;
  }
  ...
  **/
  ...
  public ServicesCatalogueItem tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public ServicesCatalogueItem addTagsItem(String tagsItem) {
  ...
  **/
  ...
  public ServicesCatalogueItem flightIds(List<String> flightIds) {
    this.flightIds = flightIds;
    return this;
  }

  public ServicesCatalogueItem addFlightIdsItem(String flightIdsItem) {
  ...
  **/
  ...
  public ServicesCatalogueItem statusCode(String statusCode) {
    this.statusCode = statusCode;
    return this;
  }
  ...
  **/
  ...
  public ServicesCatalogueItem parameters(List<ServiceParameter> parameters) {
    this.parameters = parameters;
    return this;
  }

  public ServicesCatalogueItem addParametersItem(ServiceParameter parametersItem) {
  ...
  **/
  ...
  public ServicesCatalogueItem subServiceIds(List<String> subServiceIds) {
    this.subServiceIds = subServiceIds;
    return this;
  }

  public ServicesCatalogueItem addSubServiceIdsItem(String subServiceIdsItem) {
  ...
  **/
  ...
  public ServicesCatalogueItem isHighlighted(Boolean isHighlighted) {
    this.isHighlighted = isHighlighted;
    return this;
  }
  ...
  **/
  ...
  public ServicesCatalogueItem displayOrder(Integer displayOrder) {
    this.displayOrder = displayOrder;
    return this;
  }
  ...
  **/
  ...
  public ServicesCatalogueItem media(List<RichMedia> media) {
    this.media = media;
    return this;
  }

  public ServicesCatalogueItem addMediaItem(RichMedia mediaItem) {
  ...
  **/
  @JsonProperty("prices")
  public ServiceCataloguePricingRecords getPrices() {
    return prices;
  }

  public void setPrices(ServiceCataloguePricingRecords prices) {
    this.prices = prices;
  }

  public ServicesCatalogueItem prices(ServiceCataloguePricingRecords prices) {
    this.prices = prices;
    return this;
  }
  ...
  **/
  ...
  public ServicesCatalogueItem travelerIds(List<String> travelerIds) {
    this.travelerIds = travelerIds;
    return this;
  }

  public ServicesCatalogueItem addTravelerIdsItem(String travelerIdsItem) {
  ...
  public String toString() {
    ...
    sb.append("class ServicesCatalogueItem {\n");
