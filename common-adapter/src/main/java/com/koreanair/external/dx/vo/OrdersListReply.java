...
/**
  * Reply containing a list of orders
 **/
@ApiModel(description="Reply containing a list of orders")
public class OrdersListReply  {
  ...
  **/
  ...
  public OrdersListReply errors(List<ErrorMessage> errors) {
    this.errors = errors;
    return this;
  }

  public OrdersListReply addErrorsItem(ErrorMessage errorsItem) {
  ...
  **/
  ...
  public OrdersListReply warnings(List<WarningMessage> warnings) {
    this.warnings = warnings;
    return this;
  }

  public OrdersListReply addWarningsItem(WarningMessage warningsItem) {
  ...
  **/
  ...
  public OrdersListReply data(List<Order> data) {
    this.data = data;
    return this;
  }

  public OrdersListReply addDataItem(Order dataItem) {
  ...
  **/
  ...
  public OrdersListReply dictionaries(OrderDictionary dictionaries) {
    this.dictionaries = dictionaries;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class OrdersListReply {\n");
