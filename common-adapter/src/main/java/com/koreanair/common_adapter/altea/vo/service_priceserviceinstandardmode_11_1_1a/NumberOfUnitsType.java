 ...
 *       &lt;sequence>
 *         &lt;element name="quantityDetails" type="{http://xml.amadeus.com/TPSSGQ_11_1_1A}NumberOfUnitDetailsType_159479C" maxOccurs="99"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class NumberOfUnitsType {
    ...
    protected List<NumberOfUnitDetailsType159479C> quantityDetails;
     ...
     * {@link NumberOfUnitDetailsType159479C }
     * 
     * 
     */
    public List<NumberOfUnitDetailsType159479C> getQuantityDetails() {
        if (quantityDetails == null) {
            quantityDetails = new ArrayList<NumberOfUnitDetailsType159479C>();
        }
