 ...
 *       &lt;sequence>
 *         &lt;element name="companyIdentification" type="{http://xml.amadeus.com/TPISGQ_11_1_1A}CompanyIdentificationTypeI"/>
 *         &lt;element name="productIdentificationDetails" type="{http://xml.amadeus.com/TPISGQ_11_1_1A}ProductIdentificationDetailsTypeI" maxOccurs="99" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TransportIdentifierTypeI {
    ...
    protected List<ProductIdentificationDetailsTypeI> productIdentificationDetails;
     ...
     * 
     */
    public List<ProductIdentificationDetailsTypeI> getProductIdentificationDetails() {
        if (productIdentificationDetails == null) {
            productIdentificationDetails = new ArrayList<ProductIdentificationDetailsTypeI>();
        }
