...
public class GenericException extends RuntimeException {
	...
	public enum ExceptionCode {
		...
		BAD_REQUEST(HttpStatus.BAD_REQUEST, Level.WARN, "잘못된 요청입니다."), // 사용자의 잘못된 요청

		NOT_FOUND(HttpStatus.NOT_FOUND, Level.WARN, "요청하신 RESOURCE가 없습니다."), // 요청을 처리할 Controller 메서드가 없거나 웹자원이 없음

		UNSUPPORTED_MEDIA_TYPE(HttpStatus.UNSUPPORTED_MEDIA_TYPE, Level.ERROR, "지원되지 않는 미디어 타입입니다."), // 잘못된 미디어 타입

		/* 데이터 예외 */
		DB_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, Level.ERROR, "DB 에러가 발생하였습니다."), // 기타 DB 관련 예외

		/* 서버 예외 */
		INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, Level.ERROR, "서버 에러가 발생하였습니다."), // 예측되지 않은 시스템 예외

		/* 업무 예외 */
		BUSINESS_ERROR(HttpStatus.FORBIDDEN, Level.WARN, "업무 예외가 발생하였습니다.");

		private final HttpStatus httpStatus;
		private final Level level;
		private final String message;

		ExceptionCode(HttpStatus httpStatus, Level level, String message) {
